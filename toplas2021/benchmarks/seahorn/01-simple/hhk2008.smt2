(set-info :original "01-simple/hhk2008.bc")
...
(rule (let ((a!1 (and main@entry
                ...
                (=> (and main@_bb_0 main@.lr.ph_0)
                    (= main@%.02.i2_0 main@%_1_0))
                (=> (and main@_bb_0 main@.lr.ph_0)
                    (= main@%.03.i1_0 main@%_0_0))
                (=> (and main@_bb_0 main@.lr.ph_0)
                    (= main@%.02.i2_1 main@%.02.i2_0))
                (=> (and main@_bb_0 main@.lr.ph_0)
                    (= main@%.03.i1_1 main@%.03.i1_0)))))
  (=> a!1 (main@_bb main@%_1_0 main@%_0_0 main@%.02.i2_1 main@%.03.i1_1))))
(rule (let ((a!1 (and main@entry
                true
                (= main@%_2_0 (< main@%_0_0 1000001))
                (= main@%_3_0
                ...
                (=> (and main@verifier.error_0 main@entry_0)
                    (= main@%.03.i.lcssa_0 main@%_0_0))
                (=> (and main@verifier.error_0 main@entry_0)
                    (= main@%.03.i.lcssa_1 main@%.03.i.lcssa_0))
                (=> main@verifier.error_0
                    (= main@%_9_0 (+ main@%_1_0 main@%_0_0)))
                (=> main@verifier.error_0
...
(rule (=> (and (main@_bb main@%_1_0 main@%_0_0 main@%.02.i2_0 main@%.03.i1_0)
         true
         (= main@%_6_0 (+ main@%.02.i2_0 (- 1)))
         (= main@%_7_0 (+ main@%.03.i1_0 1))
         (= main@%_8_0 (> main@%.02.i2_0 1))
         (=> main@_bb_1 (and main@_bb_1 main@_bb_0))
         main@_bb_1
         (=> (and main@_bb_1 main@_bb_0) main@%_8_0)
         (=> (and main@_bb_1 main@_bb_0) (= main@%.02.i2_1 main@%_6_0))
         (=> (and main@_bb_1 main@_bb_0) (= main@%.03.i1_1 main@%_7_0))
         (=> (and main@_bb_1 main@_bb_0) (= main@%.02.i2_2 main@%.02.i2_1))
         (=> (and main@_bb_1 main@_bb_0) (= main@%.03.i1_2 main@%.03.i1_1)))
    (main@_bb main@%_1_0 main@%_0_0 main@%.02.i2_2 main@%.03.i1_2)))
(rule (let ((a!1 (and (main@_bb main@%_1_0 main@%_0_0 main@%.02.i2_0 main@%.03.i1_0)
                true
                (= main@%_6_0 (+ main@%.02.i2_0 (- 1)))
                (= main@%_7_0 (+ main@%.03.i1_0 1))
                (= main@%_8_0 (> main@%.02.i2_0 1))
                ...
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%.03.i.lcssa_0 main@%.lcssa_1))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%.03.i.lcssa_1 main@%.03.i.lcssa_0))
                (=> main@verifier.error_0
                    (= main@%_9_0 (+ main@%_1_0 main@%_0_0)))
