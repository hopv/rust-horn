(set-info :original "7-trees/3-inc-some-two-0.bc")
...
(declare-rel main@some.exit11.split ())
...
(declare-var main@some.exit11_0 Bool )
(declare-var main@%.tr1.ph.i116.lcssa_0 Int )
(declare-var main@some.exit11.split_0 Bool )
...
(let ((a!3 (and (main@tailrecurse.i
                ...
                (=> main@tailrecurse.outer.backedge.i_0
                    (= main@%.tr1.ph.be.i_0
                       (select main@%_3_0 main@%.tr1.ph.be.in.i_0)))
                (=> main@tailrecurse.outer.backedge.i_0
                    (= main@%_14_0 (= main@%.tr1.ph.be.i_0 0)))
...
(rule (let ((a!1 (= main@%_15_0 (+ (+ main@%.tr1.ph.i17.lcssa_1 (* 0 12)) 0)))
      (a!2 (= main@%_22_0 (+ (+ main@%.tr1.ph.i17.lcssa_1 (* 0 12)) 8)))
      (a!3 (= main@%_23_0 (+ (+ main@%.tr1.ph.i17.lcssa_1 (* 0 12)) 4))))
(let ((a!4 (and (main@tailrecurse.i
                ...
                (=> main@tailrecurse.i5.lr.ph_0
                    (= main@%_21_0 (= main@%_17_0 0)))
                (=> main@tailrecurse.i5.lr.ph_0 a!2)
                (=> main@tailrecurse.i5.lr.ph_0
                    (or (<= main@%.tr1.ph.i17.lcssa_1 0) (> main@%_22_0 0)))
                (=> main@tailrecurse.i5.lr.ph_0 a!3)
                (=> main@tailrecurse.i5.lr.ph_0
                    (or (<= main@%.tr1.ph.i17.lcssa_1 0) (> main@%_23_0 0)))
                (=> main@tailrecurse.i5.lr.ph_0
                    (= main@%_24_0 (ite main@%_21_0 main@%_22_0 main@%_23_0)))
                (=> main@tailrecurse.i5.lr.ph_0 (= main@%_25_0 main@%_24_0))
                (=> main@tailrecurse.i5_0
                    (and main@tailrecurse.i5_0 main@tailrecurse.i5.lr.ph_0))
                main@tailrecurse.i5_0
                (=> (and main@tailrecurse.i5_0 main@tailrecurse.i5.lr.ph_0)
                    (= main@%.tr1.ph.i116_0 main@%_25_0))
                (=> (and main@tailrecurse.i5_0 main@tailrecurse.i5.lr.ph_0)
...
(rule (let ((a!1 (= main@%_32_0 (+ (+ main@%.tr1.ph.i116_0 (* 0 12)) 8)))
      (a!2 (= main@%_33_0 (+ (+ main@%.tr1.ph.i116_0 (* 0 12)) 4))))
(let ((a!3 (and (main@tailrecurse.i5
                ...
                (=> (and main@tailrecurse.outer.backedge.i10_0
                         main@tailrecurse.i5_0)
                    main@%_28_0)
                (=> main@tailrecurse.outer.backedge.i10_0 (= main@%_29_0 @nd_0))
                (=> main@tailrecurse.outer.backedge.i10_0
                    (= main@%_31_0 (= main@%_30_0 0)))
                (=> main@tailrecurse.outer.backedge.i10_0 a!1)
                (=> main@tailrecurse.outer.backedge.i10_0
                    (or (<= main@%.tr1.ph.i116_0 0) (> main@%_32_0 0)))
                (=> main@tailrecurse.outer.backedge.i10_0 a!2)
                (=> main@tailrecurse.outer.backedge.i10_0
                    (or (<= main@%.tr1.ph.i116_0 0) (> main@%_33_0 0)))
                (=> main@tailrecurse.outer.backedge.i10_0
                    (= main@%.tr1.ph.be.in.i8_0
                       (ite main@%_31_0 main@%_32_0 main@%_33_0)))
                (=> main@tailrecurse.outer.backedge.i10_0
                    (= main@%.tr1.ph.be.i9_0
                       (select main@%_20_0 main@%.tr1.ph.be.in.i8_0)))
                (=> main@tailrecurse.outer.backedge.i10_0
                    (= main@%_34_0 (= main@%.tr1.ph.be.i9_0 0)))
  ...
  (=> a!3
      (main@tailrecurse.i5
        ...
        main@%_2_0
        main@%_4_0)))))
(rule (let ((a!1 (=> main@some.exit11_0
               (= main@%_35_0 (+ main@%.tr1.ph.i116.lcssa_1 (* 0 12) 0)))))
(let ((a!2 (and (main@tailrecurse.i5
                ...
                (= main@%_28_0 (= main@%_27_0 0))
                (=> main@some.exit11_0
                    (and main@some.exit11_0 main@tailrecurse.i5_0))
                (=> (and main@some.exit11_0 main@tailrecurse.i5_0)
                    (not main@%_28_0))
                (=> (and main@some.exit11_0 main@tailrecurse.i5_0)
                ...
                a!1
                (=> main@some.exit11_0
                    (or (<= main@%.tr1.ph.i116.lcssa_1 0) (> main@%_35_0 0)))
                (=> main@some.exit11_0 (= main@%_36_0 @nd_0))
                (=> main@some.exit11_0
                    (= main@%_38_0 (select main@%_20_0 main@%_35_0)))
                (=> main@some.exit11_0 (= main@%_39_0 (+ main@%_38_0 1)))
                (=> main@some.exit11_0
                    (= main@%_40_0 (store main@%_20_0 main@%_35_0 main@%_39_0)))
                (sum main@some.exit11_0
                     false
                     false
                     main@%_40_0
                     main@%_41_0
                     main@%_2_0
                     main@%_42_0)
                (=> main@some.exit11_0 (= main@%_43_0 (+ main@%_4_0 2)))
                (=> main@some.exit11_0
                    (= main@%_44_0 (= main@%_42_0 main@%_43_0)))
                (=> main@some.exit11_0 (not main@%_44_0))
                (=> main@some.exit11.split_0
                    (and main@some.exit11.split_0 main@some.exit11_0))
                main@some.exit11.split_0)))
  (=> a!2 main@some.exit11.split))))
(rule (let ((a!1 (= main@%_32_0 (+ (+ main@%.tr1.ph.i116_0 (* 0 12)) 8)))
      (a!2 (= main@%_33_0 (+ (+ main@%.tr1.ph.i116_0 (* 0 12)) 4))))
(let ((a!3 (and (main@tailrecurse.i5
                  @nd_0
