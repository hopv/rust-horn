(set-info :original "06-swap2-dec/swap2-dec-1-base-unsafe.bc")
...
(declare-var |tuple(main@swap2_dec.exit_0, main@verifier.error_0)| Bool )
...
(rule (=> (and (main@entry @nd_0)
         ...
         (= main@%_5_0 main@%_1_0)
         (= main@%_6_0 @nd_0)
         (= main@%sm_0 (store main@%sm9_0 main@%_1_0 main@%_7_0))
         (= main@%_8_0 main@%_2_0)
         (= main@%_9_0 @nd_0)
    ...
    (main@empty.loop main@%_7_0
                     ...
                     main@%_3_0
                     main@%_4_0)))
(rule (=> (and (main@empty.loop main@%_7_0
                          main@%_1_0
                          @nd_0
                          main@%loop.bound_0
                          main@%sm1_0
...
(rule (let ((a!1 (and (main@tailrecurse.i
                ...
                (= main@%spec.select_0 (ite main@%_13_0 main@%.07_0 main@%.0_0))
                (= main@%spec.select10_0
                   (ite main@%_13_0 main@%.0_0 main@%.07_0))
                (= main@%_14_0 @nd_0)
                ...
                (=> main@_17_0
                    (= main@%sm5_0
                       (store main@%sm4_0 main@%spec.select10_0 main@%_18_0)))
...
(rule (let ((a!1 (and (main@tailrecurse.i
                ...
                (=> main@_32_0 (and main@_32_0 main@swap2_dec.exit_0))
                (=> (and main@_32_0 main@swap2_dec.exit_0) (not main@%_31_0))
                (=> main@_32_0 (= main@%_33_0 (- main@%_7_0 main@%_30_0)))
                (=> main@_32_0 (= main@%_34_0 (< main@%_33_0 4)))
                (=> main@_32_0 (not main@%_34_0))
                (=> |tuple(main@swap2_dec.exit_0, main@verifier.error_0)|
                    main@swap2_dec.exit_0)
                (=> main@verifier.error_0
                    (or |tuple(main@swap2_dec.exit_0, main@verifier.error_0)|
                        (and main@verifier.error_0 main@_32_0)))
                (=> |tuple(main@swap2_dec.exit_0, main@verifier.error_0)|
                    main@%_31_0)
