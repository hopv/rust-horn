...
(rule (let ((a!1 (and (main@tailrecurse.i
                ...
                (=> (and main@_bb3_0 main@swap2_dec.exit_0) (not main@%_40_0))
                (=> main@_bb3_0 (= main@%_42_0 (- main@%_8_0 main@%_39_0)))
                (=> main@_bb3_0 (= main@%_43_0 (< main@%_42_0 4)))
                (=> main@_bb3_0 (not main@%_43_0))
                (=> |tuple(main@swap2_dec.exit_0, main@verifier.error_0)|
                    main@swap2_dec.exit_0)
                (=> main@verifier.error_0
                    (or (and main@swap2_dec.exit_0
                             |tuple(main@swap2_dec.exit_0, main@verifier.error_0)|)
                        (and main@verifier.error_0 main@_bb3_0)))
                (=> (and main@swap2_dec.exit_0
                         |tuple(main@swap2_dec.exit_0, main@verifier.error_0)|)
                    main@%_40_0)
