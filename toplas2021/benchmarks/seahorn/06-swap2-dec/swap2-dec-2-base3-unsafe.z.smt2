(set-info :original "06-swap2-dec/swap2-dec-2-base3-unsafe.bc")
...
(rule (let ((a!1 (and (main@tailrecurse.i
                ...
                (= main@%spec.select_0
                   (ite main@%_18_0 main@%.019_0 main@%.017_0))
                (= main@%spec.select24_0
                   (ite main@%_18_0 main@%.017_0 main@%.019_0))
                (= main@%_19_0 @nd_0)
                (= main@%_21_0 (= main@%_20_0 0))
                (= main@%.2_0
                   (ite main@%_21_0 main@%spec.select24_0 main@%.0_0))
                (= main@%.1_0
                   (ite main@%_21_0 main@%.0_0 main@%spec.select24_0))
                (= main@%_22_0 @nd_0)
                ...
                (=> main@_28_0
                    (= main@%sm7_0
                       (store main@%sm6_0 main@%spec.select26_0 main@%_29_0)))
                ...
                (=> main@_40_0
                    (= main@%sm11_0
                       (store main@%sm10_0 main@%spec.select26_0 main@%_41_0)))
...
(rule (let ((a!1 (and (main@tailrecurse.i
                ...
                (=> main@_58_0 (and main@_58_0 main@swap2_dec_three.exit_0))
                (=> (and main@_58_0 main@swap2_dec_three.exit_0)
                    (not main@%_57_0))
                (=> main@_58_0 (= main@%_59_0 (- main@%_9_0 main@%_56_0)))
                (=> main@_58_0 (= main@%_60_0 (< main@%_59_0 4)))
                (=> main@_58_0 (not main@%_60_0))
                (=> |tuple(main@swap2_dec_three.exit_0, main@verifier.error_0)|
                    main@swap2_dec_three.exit_0)
                (=> main@verifier.error_0
                    (or |tuple(main@swap2_dec_three.exit_0, main@verifier.error_0)|
                        (and main@verifier.error_0 main@_58_0)))
                (=> |tuple(main@swap2_dec_three.exit_0, main@verifier.error_0)|
                    main@%_57_0)
