(set-info :original "09-lists/lists-3-inc-some-unsafe.bc")
...
(declare-rel main@tailrecurse.i (Int (Array Int Int) Bool Int Int Int Int ))
(declare-rel main@tailrecurse.i1 (Int Int (Array Int Int) Int Bool Int Int ))
(declare-rel main@tailrecurse.i4 ((Array Int Int) Int Int (Array Int Int) Int ))
...
(declare-var main@%.tr3.i2_2 Int )
(declare-var main@%accumulator.tr2.i3_2 Int )
...
(declare-var main@take_some.exit_0 Bool )
(declare-var main@%sm_0 (Array Int Int) )
(declare-var main@tailrecurse.i4_0 Bool )
(declare-var main@%.tr3.i2_0 Int )
(declare-var main@%accumulator.tr2.i3_0 Int )
(declare-var main@%.tr3.i2_1 Int )
(declare-var main@%accumulator.tr2.i3_1 Int )
...
(rule (=> (and (main@entry @nd_0)
         ...
         (=> (and main@tailrecurse.i_0 main@entry_0) (not main@%_2_0))
...
(rule (=> (and (main@entry @nd_0)
    ...
    (main@tailrecurse.i1
      ...
      main@%_1_0
      main@%loop.bound_0)))
(rule (let ((a!1 (= main@%_3_0 (+ (+ main@%.tr3.i_0 (* 0 8)) 0)))
      (a!2 (= main@%_5_0 (+ (+ main@%.tr3.i_0 (* 0 8)) 4))))
  (=> (and (main@tailrecurse.i
           ...
           true
           a!1
           (or (<= main@%.tr3.i_0 0) (> main@%_3_0 0))
           (= main@%_4_0 (select main@%sh_0 main@%_3_0))
           a!2
           (or (<= main@%.tr3.i_0 0) (> main@%_5_0 0))
           (> main@%.tr3.i_0 0)
           (= main@%_6_0 (select main@%sh_0 main@%_5_0))
           (= main@%_7_0 (+ main@%_4_0 main@%accumulator.tr2.i_0))
           (= main@%_8_0 (= main@%_6_0 0))
           (=> main@tailrecurse.i_1
               (and main@tailrecurse.i_1 main@tailrecurse.i_0))
           (=> (and main@tailrecurse.i_1 main@tailrecurse.i_0) (not main@%_8_0))
           (=> (and main@tailrecurse.i_1 main@tailrecurse.i_0)
               (= main@%.tr3.i_1 main@%_6_0))
           (=> (and main@tailrecurse.i_1 main@tailrecurse.i_0)
               (= main@%accumulator.tr2.i_1 main@%_7_0))
           (=> (and main@tailrecurse.i_1 main@tailrecurse.i_0)
...
(let ((a!3 (and (main@tailrecurse.i
  ...
  (=> a!3
      (main@tailrecurse.i1
        ...
        main@%_1_0
        main@%loop.bound_0)))))
(rule (let ((a!1 (=> main@_14_0 (= main@%_15_0 (+ main@%.tr.i_0 (* 0 8) 4)))))
(let ((a!2 (and (main@tailrecurse.i1
                  ...
                  main@%loop.bound_0)
                true
                (= main@%_9_0 (= main@%.tr.i_0 0))
                (=> main@_10_0 (and main@_10_0 main@tailrecurse.i1_0))
                (=> (and main@_10_0 main@tailrecurse.i1_0) (not main@%_9_0))
                (=> main@_10_0 (= main@%_11_0 @nd_0))
                (=> main@_10_0
                    (= main@%_13_0 (= main@%_12_0 main@%loop.bound_0)))
                (=> main@_14_0 (and main@_14_0 main@_10_0))
                (=> (and main@_14_0 main@_10_0) main@%_13_0)
                a!1
                (=> main@_14_0 (or (<= main@%.tr.i_0 0) (> main@%_15_0 0)))
                (=> main@_14_0 (> main@%.tr.i_0 0))
                (=> main@_14_0 (= main@%_16_0 (select main@%sh_0 main@%_15_0)))
                (=> |tuple(main@tailrecurse.i1_0, main@tailrecurse.i1.backedge_0)|
                    main@tailrecurse.i1_0)
                (=> main@tailrecurse.i1.backedge_0
                    (or (and main@tailrecurse.i1.backedge_0 main@_14_0)
                        |tuple(main@tailrecurse.i1_0, main@tailrecurse.i1.backedge_0)|))
                (=> |tuple(main@tailrecurse.i1_0, main@tailrecurse.i1.backedge_0)|
                    main@%_9_0)
                (=> (and main@tailrecurse.i1.backedge_0 main@_14_0)
                    (= main@%.tr.i.be_0 main@%_16_0))
                (=> |tuple(main@tailrecurse.i1_0, main@tailrecurse.i1.backedge_0)|
                    (= main@%.tr.i.be_1 0))
                (=> (and main@tailrecurse.i1.backedge_0 main@_14_0)
  ...
  (=> a!2
      (main@tailrecurse.i1
        ...
        main@%_1_0
        main@%loop.bound_0)))))
(rule (let ((a!1 (=> main@take_some.exit_0
               (= main@%_17_0 (+ main@%.tr.i_0 (* 0 8) 0)))))
(let ((a!2 (and (main@tailrecurse.i1
                  @nd_0
                  main@%.tr.i_0
                  main@%sh_0
                ...
                (=> main@_10_0
                    (= main@%_13_0 (= main@%_12_0 main@%loop.bound_0)))
                (=> main@take_some.exit_0
                    (and main@take_some.exit_0 main@_10_0))
                (=> (and main@take_some.exit_0 main@_10_0) (not main@%_13_0))
                a!1
                (=> main@take_some.exit_0
                    (or (<= main@%.tr.i_0 0) (> main@%_17_0 0)))
                (=> main@take_some.exit_0
                    (= main@%_18_0 (select main@%sh_0 main@%_17_0)))
                (=> main@take_some.exit_0 (= main@%_19_0 (+ main@%_18_0 1)))
                (=> main@take_some.exit_0
                    (= main@%sm_0 (store main@%sh_0 main@%_17_0 main@%_19_0)))
                (=> main@tailrecurse.i4_0
                    (and main@tailrecurse.i4_0 main@take_some.exit_0))
                (=> (and main@tailrecurse.i4_0 main@take_some.exit_0)
                    (not main@%_2_0))
                (=> (and main@tailrecurse.i4_0 main@take_some.exit_0)
                    (= main@%.tr3.i2_0 main@%_1_0))
                (=> (and main@tailrecurse.i4_0 main@take_some.exit_0)
                    (= main@%accumulator.tr2.i3_0 0))
                (=> (and main@tailrecurse.i4_0 main@take_some.exit_0)
                    (= main@%.tr3.i2_1 main@%.tr3.i2_0))
                (=> (and main@tailrecurse.i4_0 main@take_some.exit_0)
                    (= main@%accumulator.tr2.i3_1 main@%accumulator.tr2.i3_0))
                main@tailrecurse.i4_0)))
  (=> a!2
      (main@tailrecurse.i4
        main@%sh_0
...
(let ((a!2 (and (main@tailrecurse.i1
                ...
                (=> main@take_some.exit_0
                    (= main@%sm_0 (store main@%sh_0 main@%_17_0 main@%_19_0)))
                (=> main@sum.exit6_0
                    (and main@sum.exit6_0 main@take_some.exit_0))
                (=> (and main@sum.exit6_0 main@take_some.exit_0) main@%_2_0)
                (=> (and main@sum.exit6_0 main@take_some.exit_0)
                ...
                main@sum.exit6.split_0)))
  (=> a!2 main@sum.exit6.split))))
(rule (let ((a!1 (= main@%_20_0 (+ (+ main@%.tr3.i2_0 (* 0 8)) 0)))
      (a!2 (= main@%_22_0 (+ (+ main@%.tr3.i2_0 (* 0 8)) 4))))
  (=> (and (main@tailrecurse.i4
             main@%sh_0
             main@%accumulator.tr.lcssa.i_0
             main@%.tr3.i2_0
             main@%sm_0
             main@%accumulator.tr2.i3_0)
           true
           a!1
           (or (<= main@%.tr3.i2_0 0) (> main@%_20_0 0))
           (= main@%_21_0 (select main@%sm_0 main@%_20_0))
           a!2
           (or (<= main@%.tr3.i2_0 0) (> main@%_22_0 0))
           (> main@%.tr3.i2_0 0)
           (= main@%_23_0 (select main@%sh_0 main@%_22_0))
           (= main@%_24_0 (+ main@%_21_0 main@%accumulator.tr2.i3_0))
           ...
           (=> (and main@tailrecurse.i4_1 main@tailrecurse.i4_0)
               (not main@%_25_0))
           (=> (and main@tailrecurse.i4_1 main@tailrecurse.i4_0)
               (= main@%.tr3.i2_1 main@%_23_0))
           (=> (and main@tailrecurse.i4_1 main@tailrecurse.i4_0)
               (= main@%accumulator.tr2.i3_1 main@%_24_0))
           (=> (and main@tailrecurse.i4_1 main@tailrecurse.i4_0)
               (= main@%.tr3.i2_2 main@%.tr3.i2_1))
           (=> (and main@tailrecurse.i4_1 main@tailrecurse.i4_0)
               (= main@%accumulator.tr2.i3_2 main@%accumulator.tr2.i3_1))
           main@tailrecurse.i4_1)
      (main@tailrecurse.i4
        main@%sh_0
        main@%accumulator.tr.lcssa.i_0
...
(let ((a!3 (and (main@tailrecurse.i4
                ...
                (=> (and main@sum.exit6_0 main@tailrecurse.i4_0)
                    (= main@%accumulator.tr.lcssa.i5_0 main@%_24_0))
                (=> (and main@sum.exit6_0 main@tailrecurse.i4_0)
                    (= main@%accumulator.tr.lcssa.i5_1
                       main@%accumulator.tr.lcssa.i5_0))
                (=> main@sum.exit6_0
