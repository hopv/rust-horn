...
(declare-var main@%.0..0..0.3.i_0 Int )
(declare-var main@%.0..0..0..i_0 Int )
...
(rule (=> (and (main@entry @nd_0)
         ...
         (= main@%.0..0..0.3.i_0 (select main@%_12_0 main@%_1_0))
         (= main@%.0..0..0..i_0 (select main@%_12_0 main@%_2_0))
         (= main@%_13_0 (+ main@%.0..0..0..i_0 1))
         (= main@%_14_0 (= main@%.0..0..0.3.i_0 main@%_13_0))
         main@%_14_0
