(set-info :original "08-linger-dec/linger-dec-2-basic3-unsafe.bc")
...
(rule (=> (and (main@entry @nd_0)
         ...
         (linger_dec_three true
                           ...
                           main@%_1_0
                           main@%_2_0)
         (= main@%_12_0 (+ main@%_5_0 (- 1)))
         (= main@%_13_0 (select main@%sh_0 main@%_0_0))
         (= main@%_14_0 (> main@%_12_0 main@%_13_0))
         (not main@%_14_0)
