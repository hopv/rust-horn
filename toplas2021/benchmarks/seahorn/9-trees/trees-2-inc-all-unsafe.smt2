(set-info :original "9-trees/trees-2-inc-all-unsafe.bc")
...
(declare-rel inc_all@_2 ((Array Int Int) Int ))
...
(declare-var inc_all@%_6_0 Int )
(declare-var inc_all@%_tail1_0 (Array Int Int) )
(declare-var inc_all@%_call2_0 Int )
(declare-var inc_all@%_9_0 Int )
(declare-var inc_all@%_10_0 Int )
(declare-var inc_all@%_call3_0 Int )
(declare-var inc_all@%_br5_0 Bool )
(declare-var inc_all@%shadow.mem.0_2 (Array Int Int) )
(declare-var inc_all@%.tr1_2 Int )
(declare-var inc_all@%_br_0 Bool )
(declare-var inc_all@%_tail_0 (Array Int Int) )
(declare-var inc_all@%shadow.mem.1_0 (Array Int Int) )
(declare-var inc_all@arg.0_0 Int )
(declare-var inc_all@_2_0 Bool )
(declare-var inc_all@.lr.ph_0 Bool )
(declare-var inc_all@tailrecurse_0 Bool )
(declare-var inc_all@%shadow.mem.0_0 (Array Int Int) )
(declare-var inc_all@%.tr1_0 Int )
(declare-var inc_all@%shadow.mem.0_1 (Array Int Int) )
(declare-var inc_all@%.tr1_1 Int )
(declare-var inc_all@tailrecurse._crit_edge_0 Bool )
(declare-var inc_all@%shadow.mem.1_1 (Array Int Int) )
(declare-var inc_all@%_store_0 (Array Int Int) )
(declare-var inc_all@%_tail4_0 Int )
(declare-var inc_all@tailrecurse_1 Bool )
(declare-var inc_all@tailrecurse._crit_edge.loopexit_0 Bool )
...
(rule (inc_all false
         ...
         inc_all@%shadow.mem.1_0
         inc_all@arg.0_0))
(rule (inc_all@_2 inc_all@%_tail_0 inc_all@arg.0_0))
(rule (=> (and (inc_all@_2 inc_all@%_tail_0 inc_all@arg.0_0)
         true
         (= inc_all@%_br_0 (= inc_all@arg.0_0 0))
         (=> inc_all@.lr.ph_0 (and inc_all@.lr.ph_0 inc_all@_2_0))
         (=> (and inc_all@.lr.ph_0 inc_all@_2_0) (not inc_all@%_br_0))
         (=> inc_all@tailrecurse_0 (and inc_all@tailrecurse_0 inc_all@.lr.ph_0))
         inc_all@tailrecurse_0
         (=> (and inc_all@tailrecurse_0 inc_all@.lr.ph_0)
             (= inc_all@%shadow.mem.0_0 inc_all@%_tail_0))
         (=> (and inc_all@tailrecurse_0 inc_all@.lr.ph_0)
             (= inc_all@%.tr1_0 inc_all@arg.0_0))
         (=> (and inc_all@tailrecurse_0 inc_all@.lr.ph_0)
             (= inc_all@%shadow.mem.0_1 inc_all@%shadow.mem.0_0))
         (=> (and inc_all@tailrecurse_0 inc_all@.lr.ph_0)
             (= inc_all@%.tr1_1 inc_all@%.tr1_0)))
    (inc_all@tailrecurse
      inc_all@%_tail_0
      inc_all@%.tr1_1
      inc_all@%shadow.mem.0_1
      inc_all@arg.0_0)))
(rule (=> (and (inc_all@_2 inc_all@%_tail_0 inc_all@arg.0_0)
         true
         (= inc_all@%_br_0 (= inc_all@arg.0_0 0))
         (=> inc_all@tailrecurse._crit_edge_0
             (and inc_all@tailrecurse._crit_edge_0 inc_all@_2_0))
         inc_all@tailrecurse._crit_edge_0
         (=> (and inc_all@tailrecurse._crit_edge_0 inc_all@_2_0) inc_all@%_br_0)
         (=> (and inc_all@tailrecurse._crit_edge_0 inc_all@_2_0)
             (= inc_all@%shadow.mem.1_0 inc_all@%_tail_0))
         (=> (and inc_all@tailrecurse._crit_edge_0 inc_all@_2_0)
             (= inc_all@%shadow.mem.1_1 inc_all@%shadow.mem.1_0)))
    (inc_all@tailrecurse._crit_edge
      inc_all@%_tail_0
      inc_all@%shadow.mem.1_1
      inc_all@arg.0_0)))
(rule (let ((a!1 (= inc_all@%_call_0 (+ (+ inc_all@%.tr1_0 (* 0 12)) 4)))
  ...
  (=> (and (inc_all@tailrecurse
             inc_all@%_tail_0
             inc_all@%.tr1_0
             inc_all@%shadow.mem.0_0
             inc_all@arg.0_0)
           true
           a!1
           (or (<= inc_all@%.tr1_0 0) (> inc_all@%_call_0 0))
           (> inc_all@%.tr1_0 0)
           (= inc_all@%_6_0 (select inc_all@%shadow.mem.0_0 inc_all@%_call_0))
           (inc_all true
                    false
                    false
                    inc_all@%shadow.mem.0_0
           ...
           (= inc_all@%_9_0 (select inc_all@%_tail1_0 inc_all@%_call2_0))
           (= inc_all@%_10_0 (+ inc_all@%_9_0 1))
           (= inc_all@%_store_0
              (store inc_all@%_tail1_0 inc_all@%_call2_0 inc_all@%_10_0))
           a!3
           (or (<= inc_all@%.tr1_0 0) (> inc_all@%_call3_0 0))
           (> inc_all@%.tr1_0 0)
           (= inc_all@%_tail4_0 (select inc_all@%_store_0 inc_all@%_call3_0))
           (= inc_all@%_br5_0 (= inc_all@%_tail4_0 0))
           ...
           (=> (and inc_all@tailrecurse_1 inc_all@tailrecurse_0)
               (not inc_all@%_br5_0))
           (=> (and inc_all@tailrecurse_1 inc_all@tailrecurse_0)
               (= inc_all@%shadow.mem.0_1 inc_all@%_store_0))
           (=> (and inc_all@tailrecurse_1 inc_all@tailrecurse_0)
               (= inc_all@%.tr1_1 inc_all@%_tail4_0))
           (=> (and inc_all@tailrecurse_1 inc_all@tailrecurse_0)
               (= inc_all@%shadow.mem.0_2 inc_all@%shadow.mem.0_1))
           (=> (and inc_all@tailrecurse_1 inc_all@tailrecurse_0)
               (= inc_all@%.tr1_2 inc_all@%.tr1_1)))
      (inc_all@tailrecurse
        inc_all@%_tail_0
        inc_all@%.tr1_2
        inc_all@%shadow.mem.0_2
        inc_all@arg.0_0))))
(rule (let ((a!1 (= inc_all@%_call_0 (+ (+ inc_all@%.tr1_0 (* 0 12)) 4)))
      (a!2 (= inc_all@%_call2_0 (+ (+ inc_all@%.tr1_0 (* 0 12)) 0)))
      (a!3 (= inc_all@%_call3_0 (+ (+ inc_all@%.tr1_0 (* 0 12)) 8))))
  (=> (and (inc_all@tailrecurse
           ...
           (= inc_all@%_tail4_0 (select inc_all@%_store_0 inc_all@%_call3_0))
           (= inc_all@%_br5_0 (= inc_all@%_tail4_0 0))
           (=> inc_all@tailrecurse._crit_edge.loopexit_0
               (and inc_all@tailrecurse._crit_edge.loopexit_0
                    inc_all@tailrecurse_0))
           (=> (and inc_all@tailrecurse._crit_edge.loopexit_0
                    inc_all@tailrecurse_0)
               inc_all@%_br5_0)
           (=> inc_all@tailrecurse._crit_edge_0
               (and inc_all@tailrecurse._crit_edge_0
                    inc_all@tailrecurse._crit_edge.loopexit_0))
           inc_all@tailrecurse._crit_edge_0
           (=> (and inc_all@tailrecurse._crit_edge_0
                    inc_all@tailrecurse._crit_edge.loopexit_0)
               (= inc_all@%shadow.mem.1_0 inc_all@%_store_0))
           (=> (and inc_all@tailrecurse._crit_edge_0
                    inc_all@tailrecurse._crit_edge.loopexit_0)
               (= inc_all@%shadow.mem.1_1 inc_all@%shadow.mem.1_0)))
      (inc_all@tailrecurse._crit_edge
...
(rule (=> (and main@entry
         ...
         (inc_all true false false main@%_5_0 main@%_7_0 main@%_2_0)
