(set-info :original "9-trees/trees-3-inc-some-unsafe.bc")
...
(let ((a!2 (and (main@tailrecurse.i
                ...
                (=> main@inc_some.exit_0
                    (and main@inc_some.exit_0 main@tailrecurse.i_0))
                (=> (and main@inc_some.exit_0 main@tailrecurse.i_0)
                    (not main@%_8_0))
                (=> (and main@inc_some.exit_0 main@tailrecurse.i_0)
                ...
                (=> main@inc_some.exit_0 (= main@%_17_0 (+ main@%_16_0 1)))
                (=> main@inc_some.exit_0
                ...
                (sum main@inc_some.exit_0
                     ...
                     main@%_2_0
                     main@%_20_0)
                (=> main@inc_some.exit_0 (= main@%_21_0 (+ main@%_4_0 1)))
                (=> main@inc_some.exit_0
                    (= main@%_22_0 (> main@%_20_0 main@%_21_0)))
                (=> main@inc_some.exit_0 (not main@%_22_0))
