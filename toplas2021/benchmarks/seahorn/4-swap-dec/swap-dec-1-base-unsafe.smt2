(set-info :original "4-swap-dec/swap-dec-1-base-unsafe.bc")
...
(rule (let ((a!1 (and (main@entry @nd_0)
                ...
                (=> (and main@_bb_0 main@swap_dec.exit_0) (not main@%_27_0))
                (=> main@_bb_0 (= main@%_29_0 (- main@%_4_0 main@%.0.7_1)))
                (=> main@_bb_0 (= main@%_30_0 (< main@%_29_0 4)))
                (=> main@_bb_0 (not main@%_30_0))
