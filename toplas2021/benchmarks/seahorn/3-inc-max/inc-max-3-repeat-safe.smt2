(set-info :original "3-inc-max/inc-max-3-repeat-safe.bc")
...
(declare-var main@%.tr3.i12_2 Int )
(declare-var main@%_12_0 Bool )
(declare-var main@%..i.i11_0 Int )
...
(declare-var main@%.tr3.i12_0 Int )
(declare-var main@%shadow.mem.0_1 (Array Int Int) )
(declare-var main@%.tr3.i12_1 Int )
...
(rule (let ((a!1 (and (main@entry @nd_0)
                ...
                (=> main@.lr.ph.i_0
                    (= main@%..i.i11_0 (ite main@%_12_0 main@%_2_0 main@%_1_0)))
                (=> main@.lr.ph.i_0
                    (= main@%_13_0 (select main@%_10_0 main@%..i.i11_0)))
                (=> main@.lr.ph.i_0 (= main@%_14_0 (+ main@%_13_0 1)))
                (=> main@.lr.ph.i_0
                    (= main@%_15_0
                       (store main@%_10_0 main@%..i.i11_0 main@%_14_0)))
                (=> main@.lr.ph.i_0 (= main@%_16_0 (= main@%_4_0 1)))
                ...
                (=> (and main@tailrecurse.i.tailrecurse.i_crit_edge_0
                         main@tailrecurse.i.tailrecurse.i_crit_edge.lr.ph_0)
                    (= main@%.tr3.i12_0 main@%_4_0))
                (=> (and main@tailrecurse.i.tailrecurse.i_crit_edge_0
                         main@tailrecurse.i.tailrecurse.i_crit_edge.lr.ph_0)
                    (= main@%shadow.mem.0_1 main@%shadow.mem.0_0))
                (=> (and main@tailrecurse.i.tailrecurse.i_crit_edge_0
                         main@tailrecurse.i.tailrecurse.i_crit_edge.lr.ph_0)
                    (= main@%.tr3.i12_1 main@%.tr3.i12_0)))))
  (=> a!1
...
(rule (let ((a!1 (and (main@entry @nd_0)
                ...
                (=> main@inc_max_repeat.exit_0
                    (= main@%_23_0 (- main@%.0.4_2 main@%.0._2)))
                (=> main@inc_max_repeat.exit_0
                    (= main@%_24_0 (< main@%_23_0 main@%_4_0)))
                (=> main@inc_max_repeat.exit_0 main@%_24_0)
                (=> main@inc_max_repeat.exit_0
                    (= main@%_25_0 (- main@%.0._2 main@%.0.4_2)))
                (=> main@inc_max_repeat.exit_0
                    (= main@%_26_0 (< main@%_25_0 main@%_4_0)))
                (=> main@inc_max_repeat.exit_0 main@%_26_0)
...
(rule (=> (and (main@tailrecurse.i.tailrecurse.i_crit_edge
           ...
           main@%shadow.mem.0_0)
         true
         (= main@%_17_0 (+ main@%.tr3.i12_0 (- 1)))
         (= main@%.0.6.pre_0 (select main@%shadow.mem.0_0 main@%_1_0))
         (= main@%.0.2.pre_0 (select main@%shadow.mem.0_0 main@%_2_0))
         (= main@%_18_0 (< main@%.0.6.pre_0 main@%.0.2.pre_0))
         (= main@%..i.i_0 (ite main@%_18_0 main@%_2_0 main@%_1_0))
         (= main@%_19_0 (select main@%shadow.mem.0_0 main@%..i.i_0))
         (= main@%_20_0 (+ main@%_19_0 1))
         (= main@%_21_0 (store main@%shadow.mem.0_0 main@%..i.i_0 main@%_20_0))
         (= main@%_22_0 (> main@%.tr3.i12_0 2))
         ...
         (=> (and main@tailrecurse.i.tailrecurse.i_crit_edge_1
                  main@tailrecurse.i.tailrecurse.i_crit_edge_0)
             (= main@%.tr3.i12_1 main@%_17_0))
         (=> (and main@tailrecurse.i.tailrecurse.i_crit_edge_1
                  main@tailrecurse.i.tailrecurse.i_crit_edge_0)
             (= main@%shadow.mem.0_2 main@%shadow.mem.0_1))
         (=> (and main@tailrecurse.i.tailrecurse.i_crit_edge_1
                  main@tailrecurse.i.tailrecurse.i_crit_edge_0)
             (= main@%.tr3.i12_2 main@%.tr3.i12_1)))
    (main@tailrecurse.i.tailrecurse.i_crit_edge
      main@%_4_0
      main@%_1_0
      main@%_2_0
...
(rule (let ((a!1 (and (main@tailrecurse.i.tailrecurse.i_crit_edge
                ...
                (= main@%_20_0 (+ main@%_19_0 1))
                (= main@%_21_0
                   (store main@%shadow.mem.0_0 main@%..i.i_0 main@%_20_0))
                (= main@%_22_0 (> main@%.tr3.i12_0 2))
                ...
                (=> main@inc_max_repeat.exit_0
                    (= main@%_23_0 (- main@%.0.4_1 main@%.0._1)))
                (=> main@inc_max_repeat.exit_0
                    (= main@%_24_0 (< main@%_23_0 main@%_4_0)))
                (=> main@inc_max_repeat.exit_0 main@%_24_0)
                (=> main@inc_max_repeat.exit_0
                    (= main@%_25_0 (- main@%.0._1 main@%.0.4_1)))
                (=> main@inc_max_repeat.exit_0
                    (= main@%_26_0 (< main@%_25_0 main@%_4_0)))
                (=> main@inc_max_repeat.exit_0 main@%_26_0)
                (=> main@inc_max_repeat.exit.split_0
