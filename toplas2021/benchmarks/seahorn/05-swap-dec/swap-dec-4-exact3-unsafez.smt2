...
(rule (=> (and (main@entry @nd_0)
         ...
         (> main@%_2_0 0)
         (> main@%_3_0 0)
         (distinct main@%_1_0 main@%_2_0 main@%_3_0) ; modify
         (= main@%_4_0 @nd_0)
         (= main@%.0.sroa_cast_0 main@%_1_0)
         (= main@%_6_0 @nd_0)
         (= main@%_8_0 (store main@%_0_0 main@%_1_0 main@%_7_0))
         (= main@%.0.sroa_cast17_0 main@%_2_0)
         (= main@%_9_0 @nd_0)
         (= main@%_11_0 (store main@%_8_0 main@%_2_0 main@%_10_0))
         (= main@%.0.sroa_cast18_0 main@%_3_0)
         (= main@%_12_0 @nd_0)
         (= main@%_14_0 (store main@%_11_0 main@%_3_0 main@%_13_0))
...
(rule (let ((a!1 (and (main@tailrecurse.i
                ...
                (= main@%.013..011_0
                   (ite main@%_17_0 main@%.013_0 main@%.011_0))
                (= main@%.011..013_0
                   (ite main@%_17_0 main@%.011_0 main@%.013_0))
                (= main@%_18_0 @nd_0)
                (= main@%_20_0 (= main@%_19_0 0))
                (= main@%.2_0 (ite main@%_20_0 main@%.011..013_0 main@%.0_0))
                (= main@%.1_0 (ite main@%_20_0 main@%.0_0 main@%.011..013_0))
                (= main@%_21_0 @nd_0)
                (= main@%_23_0 (= main@%_22_0 0))
                (= main@%.013..011..2_0
                   (ite main@%_23_0 main@%.013..011_0 main@%.2_0))
                (= main@%.2..013..011_0
                   (ite main@%_23_0 main@%.2_0 main@%.013..011_0))
                (= main@%_24_0 (= main@%.tr.i_0 0))
                (=> main@_bb_0 (and main@_bb_0 main@tailrecurse.i_0))
                (=> (and main@_bb_0 main@tailrecurse.i_0) (not main@%_24_0))
                (=> main@_bb_0
                    (= main@%_26_0
                ...
                (=> main@_bb_0 (= main@%_35_0 (+ main@%.tr.i_0 (- 1))))
...
(rule (let ((a!1 (and (main@tailrecurse.i
                ...
                (=> main@swap_dec_bound_three.exit_0
                    (= main@%_36_0 (< main@%_7_0 main@%.0.16_0)))
                (=> main@_bb1_0
                    (and main@_bb1_0 main@swap_dec_bound_three.exit_0))
                (=> (and main@_bb1_0 main@swap_dec_bound_three.exit_0)
                    (not main@%_36_0))
                (=> main@_bb1_0 (= main@%_38_0 (- main@%_7_0 main@%.0.16_0)))
                (=> main@_bb1_0 (= main@%_39_0 (* main@%_5_0 3)))
                (=> main@_bb1_0 (= main@%_40_0 (< main@%_38_0 main@%_39_0)))
                (=> main@_bb1_0 (not main@%_40_0))
