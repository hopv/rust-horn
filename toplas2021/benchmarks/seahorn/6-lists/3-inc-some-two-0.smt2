(set-info :original "6-lists/3-inc-some-two-0.bc")
...
(declare-rel main@tailrecurse.i6 (Int Int (Array Int Int) Int Int ))
...
(declare-var main@%.tr1.ph.i221.lcssa_1 Int )
...
(declare-var main@%.tr1.ph.i22.lcssa_1 Int )
(declare-var main@%_4_0 Int )
(declare-var main@%_5_0 Int )
(declare-var main@%_6_0 Int )
(declare-var main@%_9_0 Bool )
(declare-var main@%.lcssa37_1 Int )
...
(declare-var main@%.tr1.ph.i221_0 Int )
(declare-var main@%.tr1.ph.i221_1 Int )
...
(declare-var main@%.tr1.ph.i221_2 Int )
(declare-var main@.lr.ph.i10_0 Bool )
(declare-var main@%.tr1.ph.i221.lcssa_0 Int )
...
(let ((a!3 (and (main@tailrecurse.i
                ...
                (=> (and main@sum.exit_0 main@tailrecurse.i_0)
                    (= main@%.lcssa37_0 main@%_8_0))
                (=> (and main@sum.exit_0 main@tailrecurse.i_0)
                    (= main@%.lcssa37_1 main@%.lcssa37_0))
                (=> main@sum.exit_0 (= main@%phitmp_0 (+ main@%.lcssa37_1 2)))
                ...
                main@tailrecurse.i1_0
                (=> (and main@tailrecurse.i1_0 main@tailrecurse.i1.lr.ph_0)
                    (= main@%.tr1.ph.i22_0 main@%_2_0))
                (=> (and main@tailrecurse.i1_0 main@tailrecurse.i1.lr.ph_0)
                    (= main@%.tr1.ph.i22_1 main@%.tr1.ph.i22_0)))))
  (=> a!3
      (main@tailrecurse.i1
        @nd_0
        main@%.tr1.ph.i22_1
...
(rule (let ((a!1 (=> main@tailrecurse.outer.i_0
               (= main@%_13_0 (+ main@%.tr1.ph.i22_0 (* 0 8) 4)))))
(let ((a!2 (and (main@tailrecurse.i1
                ...
                a!1
                (=> main@tailrecurse.outer.i_0
                    (or (<= main@%.tr1.ph.i22_0 0) (> main@%_13_0 0)))
                (=> main@tailrecurse.outer.i_0 (> main@%.tr1.ph.i22_0 0))
                (=> main@tailrecurse.outer.i_0
                ...
                (=> (and main@tailrecurse.i1_1 main@tailrecurse.outer.i_0)
                    (not main@%_15_0))
                (=> (and main@tailrecurse.i1_1 main@tailrecurse.outer.i_0)
                    (= main@%.tr1.ph.i22_1 main@%_14_0))
                (=> (and main@tailrecurse.i1_1 main@tailrecurse.outer.i_0)
                    (= main@%.tr1.ph.i22_2 main@%.tr1.ph.i22_1)))))
  (=> a!2
      (main@tailrecurse.i1
        @nd_0
        main@%.tr1.ph.i22_2
        ...
        main@%phitmp_0
        main@%_2_0)))))
(rule (let ((a!1 (= main@%_16_0 (+ (+ main@%.tr1.ph.i22.lcssa_1 (* 0 8)) 0)))
      (a!2 (= main@%_17_0 (+ (+ main@%.tr1.ph.i22.lcssa_1 (* 0 8)) 4))))
(let ((a!3 (and (main@tailrecurse.i1
                ...
                (=> (and main@some.exit_0 main@tailrecurse.i1_0)
                    (not main@%_12_0))
                (=> (and main@some.exit_0 main@tailrecurse.i1_0)
                    (= main@%.tr1.ph.i22.lcssa_0 main@%.tr1.ph.i22_0))
                (=> (and main@some.exit_0 main@tailrecurse.i1_0)
                    (= main@%.tr1.ph.i22.lcssa_1 main@%.tr1.ph.i22.lcssa_0))
                (=> main@some.exit_0 a!1)
                (=> main@some.exit_0
                    (or (<= main@%.tr1.ph.i22.lcssa_1 0) (> main@%_16_0 0)))
                (=> main@some.exit_0 a!2)
                (=> main@some.exit_0
                    (or (<= main@%.tr1.ph.i22.lcssa_1 0) (> main@%_17_0 0)))
                (=> main@some.exit_0 (> main@%.tr1.ph.i22.lcssa_1 0))
                (=> main@some.exit_0
                ...
                (=> main@tailrecurse.i6.lr.ph_0
                    (and main@tailrecurse.i6.lr.ph_0 main@some.exit_0))
                (=> (and main@tailrecurse.i6.lr.ph_0 main@some.exit_0)
                    (not main@%_22_0))
                ...
                main@tailrecurse.i6_0
                (=> (and main@tailrecurse.i6_0 main@tailrecurse.i6.lr.ph_0)
                    (= main@%.tr1.ph.i221_0 main@%_18_0))
                (=> (and main@tailrecurse.i6_0 main@tailrecurse.i6.lr.ph_0)
                    (= main@%.tr1.ph.i221_1 main@%.tr1.ph.i221_0)))))
  (=> a!3
      (main@tailrecurse.i6
        @nd_0
        main@%.tr1.ph.i221_1
...
(let ((a!3 (and (main@tailrecurse.i1
                ...
                (=> main@tailrecurse.outer.split.us.i4_0
                    (and main@tailrecurse.outer.split.us.i4_0 main@some.exit_0))
                (=> (and main@tailrecurse.outer.split.us.i4_0 main@some.exit_0)
                    main@%_22_0)
...
(rule (let ((a!1 (=> main@tailrecurse.outer.i3_0
               (= main@%_26_0 (+ main@%.tr1.ph.i221_0 (* 0 8) 4)))))
(let ((a!2 (and (main@tailrecurse.i6
                ...
                a!1
                (=> main@tailrecurse.outer.i3_0
                    (or (<= main@%.tr1.ph.i221_0 0) (> main@%_26_0 0)))
                (=> main@tailrecurse.outer.i3_0 (> main@%.tr1.ph.i221_0 0))
                (=> main@tailrecurse.outer.i3_0
                ...
                (=> (and main@tailrecurse.i6_1 main@tailrecurse.outer.i3_0)
                    (not main@%_28_0))
                (=> (and main@tailrecurse.i6_1 main@tailrecurse.outer.i3_0)
                    (= main@%.tr1.ph.i221_1 main@%_27_0))
                (=> (and main@tailrecurse.i6_1 main@tailrecurse.outer.i3_0)
                    (= main@%.tr1.ph.i221_2 main@%.tr1.ph.i221_1)))))
  (=> a!2
      (main@tailrecurse.i6
        @nd_0
        main@%.tr1.ph.i221_2
...
(rule (let ((a!1 (=> main@.lr.ph.i10_0
               (= main@%_29_0 (+ main@%.tr1.ph.i221.lcssa_1 (* 0 8) 0)))))
(let ((a!2 (and (main@tailrecurse.i6
                  @nd_0
                  main@%.tr1.ph.i221_0
                  main@%_21_0
                ...
                (=> (and main@.lr.ph.i10_0 main@tailrecurse.i6_0)
                    (not main@%_25_0))
                (=> (and main@.lr.ph.i10_0 main@tailrecurse.i6_0)
                    (= main@%.tr1.ph.i221.lcssa_0 main@%.tr1.ph.i221_0))
                (=> (and main@.lr.ph.i10_0 main@tailrecurse.i6_0)
                    (= main@%.tr1.ph.i221.lcssa_1 main@%.tr1.ph.i221.lcssa_0))
                a!1
                (=> main@.lr.ph.i10_0
                    (or (<= main@%.tr1.ph.i221.lcssa_1 0) (> main@%_29_0 0)))
                (=> main@.lr.ph.i10_0
                    (= main@%_30_0 (select main@%_21_0 main@%_29_0)))
                (=> main@.lr.ph.i10_0 (= main@%_31_0 (+ main@%_30_0 1)))
                (=> main@.lr.ph.i10_0
...
(rule (let ((a!1 (= main@%_33_0 (+ (+ main@%.tr2.i11_0 (* 0 8)) 0)))
      (a!2 (= main@%_35_0 (+ (+ main@%.tr2.i11_0 (* 0 8)) 4))))
  (=> (and (main@tailrecurse.i13
           ...
           true
           a!1
           (or (<= main@%.tr2.i11_0 0) (> main@%_33_0 0))
           (= main@%_34_0 (select main@%_32_0 main@%_33_0))
           a!2
           (or (<= main@%.tr2.i11_0 0) (> main@%_35_0 0))
           (> main@%.tr2.i11_0 0)
           (= main@%_36_0 (select main@%_32_0 main@%_35_0))
           (= main@%_37_0 (+ main@%_34_0 main@%accumulator.tr1.i12_0))
           ...
           (=> (and main@tailrecurse.i13_1 main@tailrecurse.i13_0)
               (not main@%_38_0))
           (=> (and main@tailrecurse.i13_1 main@tailrecurse.i13_0)
               (= main@%.tr2.i11_1 main@%_36_0))
           (=> (and main@tailrecurse.i13_1 main@tailrecurse.i13_0)
               (= main@%accumulator.tr1.i12_1 main@%_37_0))
           (=> (and main@tailrecurse.i13_1 main@tailrecurse.i13_0)
...
(let ((a!3 (and (main@tailrecurse.i13
                ...
                (=> (and main@sum.exit15_0 main@tailrecurse.i13_0) main@%_38_0)
                (=> (and main@sum.exit15_0 main@tailrecurse.i13_0)
                ...
                (=> main@sum.exit15_0 (not main@%_39_0))
