...
(declare-rel ack1@_tail (Int Int ))
(declare-rel ack1@_.tr13 (Int Int Int Int ))
...
(declare-var ack1@%_br3_0 Bool )
(declare-var ack1@%.tr1.be.lcssa_1 Int )
(declare-var ack1@%_11_0 Int )
(declare-var ack1@%_7_0 Bool )
(declare-var ack1@%.tr2_2 Int )
(declare-var ack1@%_br_0 Bool )
(declare-var ack1@arg.0_0 Int )
(declare-var ack1@arg.1_0 Int )
(declare-var ack1@%_br1_0 Int )
(declare-var ack1@_tail_0 Bool )
(declare-var ack1@.lr.ph_0 Bool )
(declare-var ack1@_.tr13_0 Bool )
(declare-var ack1@%.tr13_0 Int )
(declare-var ack1@%.tr2_0 Int )
(declare-var ack1@%.tr13_1 Int )
(declare-var ack1@%.tr2_1 Int )
(declare-var ack1@tailrecurse._crit_edge_0 Bool )
(declare-var ack1@%.tr1.lcssa_0 Int )
(declare-var ack1@%.tr1.lcssa_1 Int )
(declare-var ack1@tailrecurse._crit_edge.split_0 Bool )
(declare-var ack1@%_br2_0 Int )
(declare-var ack1@_10_0 Bool )
(declare-var ack1@%_br4_0 Int )
(declare-var ack1@tailrecurse.backedge_0 Bool )
(declare-var |tuple(ack1@_.tr13_0, ack1@tailrecurse.backedge_0)| Bool )
(declare-var ack1@%.tr1.be_0 Int )
(declare-var ack1@%.tr1.be_1 Int )
(declare-var ack1@%.tr1.be_2 Int )
(declare-var ack1@_.tr13_1 Bool )
(declare-var ack1@%.tr13_2 Int )
(declare-var ack1@tailrecurse._crit_edge.loopexit_0 Bool )
(declare-var ack1@%.tr1.be.lcssa_0 Int )
...
(rule (ack1@_tail ack1@arg.1_0 ack1@arg.0_0))
(rule (=> (and (ack1@_tail ack1@arg.1_0 ack1@arg.0_0)
         true
         (= ack1@%_br_0 (= ack1@arg.0_0 0))
         (=> ack1@.lr.ph_0 (and ack1@.lr.ph_0 ack1@_tail_0))
         (=> (and ack1@.lr.ph_0 ack1@_tail_0) (not ack1@%_br_0))
         (=> ack1@_.tr13_0 (and ack1@_.tr13_0 ack1@.lr.ph_0))
         ack1@_.tr13_0
         (=> (and ack1@_.tr13_0 ack1@.lr.ph_0) (= ack1@%.tr13_0 ack1@arg.1_0))
         (=> (and ack1@_.tr13_0 ack1@.lr.ph_0) (= ack1@%.tr2_0 ack1@arg.0_0))
         (=> (and ack1@_.tr13_0 ack1@.lr.ph_0) (= ack1@%.tr13_1 ack1@%.tr13_0))
         (=> (and ack1@_.tr13_0 ack1@.lr.ph_0) (= ack1@%.tr2_1 ack1@%.tr2_0)))
    (ack1@_.tr13 ack1@%.tr13_1 ack1@%.tr2_1 ack1@arg.1_0 ack1@arg.0_0)))
(rule (let ((a!1 (and (ack1@_tail ack1@arg.1_0 ack1@arg.0_0)
                true
                (= ack1@%_br_0 (= ack1@arg.0_0 0))
                (=> ack1@tailrecurse._crit_edge_0
                    (and ack1@tailrecurse._crit_edge_0 ack1@_tail_0))
                (=> (and ack1@tailrecurse._crit_edge_0 ack1@_tail_0)
                    ack1@%_br_0)
                (=> (and ack1@tailrecurse._crit_edge_0 ack1@_tail_0)
                    (= ack1@%.tr1.lcssa_0 ack1@arg.1_0))
                (=> (and ack1@tailrecurse._crit_edge_0 ack1@_tail_0)
                    (= ack1@%.tr1.lcssa_1 ack1@%.tr1.lcssa_0))
                (=> ack1@tailrecurse._crit_edge_0
                    (= ack1@%_br1_0 (+ ack1@%.tr1.lcssa_1 1)))
                (=> ack1@tailrecurse._crit_edge.split_0
                    (and ack1@tailrecurse._crit_edge.split_0
                         ack1@tailrecurse._crit_edge_0))
                ack1@tailrecurse._crit_edge.split_0)))
  (=> a!1
      (ack1@tailrecurse._crit_edge.split ack1@%_br1_0 ack1@arg.1_0 ack1@arg.0_0))))
(rule (let ((a!1 (and (ack1@_.tr13 ack1@%.tr13_0
                             ack1@%.tr2_0
                             ack1@arg.1_0
                             ack1@arg.0_0)
                true
                (= ack1@%_7_0 (= ack1@%.tr13_0 0))
                (= ack1@%_br2_0 (+ ack1@%.tr2_0 (- 1)))
                (=> ack1@_10_0 (and ack1@_10_0 ack1@_.tr13_0))
                (=> (and ack1@_10_0 ack1@_.tr13_0) (not ack1@%_7_0))
                (=> ack1@_10_0 (= ack1@%_11_0 (+ ack1@%.tr13_0 (- 1))))
                (ack1 ack1@_10_0
                      false
                      false
                      ack1@%.tr2_0
                      ack1@%_11_0
                      ack1@%_br4_0)
                (=> |tuple(ack1@_.tr13_0, ack1@tailrecurse.backedge_0)|
                    ack1@_.tr13_0)
                (=> ack1@tailrecurse.backedge_0
                    (or (and ack1@_.tr13_0
                             |tuple(ack1@_.tr13_0, ack1@tailrecurse.backedge_0)|)
                        (and ack1@tailrecurse.backedge_0 ack1@_10_0)))
                (=> (and ack1@_.tr13_0
                         |tuple(ack1@_.tr13_0, ack1@tailrecurse.backedge_0)|)
                    ack1@%_7_0)
                (=> (and ack1@_.tr13_0
                    ...
                    (= ack1@%.tr1.be_0 1))
                (=> (and ack1@tailrecurse.backedge_0 ack1@_10_0)
                    (= ack1@%.tr1.be_1 ack1@%_br4_0))
                (=> (and ack1@_.tr13_0
                         |tuple(ack1@_.tr13_0, ack1@tailrecurse.backedge_0)|)
                    (= ack1@%.tr1.be_2 ack1@%.tr1.be_0))
                (=> (and ack1@tailrecurse.backedge_0 ack1@_10_0)
                    (= ack1@%.tr1.be_2 ack1@%.tr1.be_1))
                (=> ack1@tailrecurse.backedge_0
                    (= ack1@%_br3_0 (= ack1@%_br2_0 0)))
                (=> ack1@_.tr13_1
                    (and ack1@_.tr13_1 ack1@tailrecurse.backedge_0))
                ack1@_.tr13_1
                (=> (and ack1@_.tr13_1 ack1@tailrecurse.backedge_0)
                    (not ack1@%_br3_0))
                (=> (and ack1@_.tr13_1 ack1@tailrecurse.backedge_0)
                    (= ack1@%.tr13_1 ack1@%.tr1.be_2))
                (=> (and ack1@_.tr13_1 ack1@tailrecurse.backedge_0)
                    (= ack1@%.tr2_1 ack1@%_br2_0))
                (=> (and ack1@_.tr13_1 ack1@tailrecurse.backedge_0)
                    (= ack1@%.tr13_2 ack1@%.tr13_1))
                (=> (and ack1@_.tr13_1 ack1@tailrecurse.backedge_0)
                    (= ack1@%.tr2_2 ack1@%.tr2_1)))))
  (=> a!1 (ack1@_.tr13 ack1@%.tr13_2 ack1@%.tr2_2 ack1@arg.1_0 ack1@arg.0_0))))
(rule (let ((a!1 (and (ack1@_.tr13 ack1@%.tr13_0
                             ack1@%.tr2_0
                             ack1@arg.1_0
                             ack1@arg.0_0)
                ...
                (=> ack1@tailrecurse.backedge_0
                    (= ack1@%_br3_0 (= ack1@%_br2_0 0)))
                (=> ack1@tailrecurse._crit_edge.loopexit_0
                    (and ack1@tailrecurse._crit_edge.loopexit_0
                         ack1@tailrecurse.backedge_0))
                (=> (and ack1@tailrecurse._crit_edge.loopexit_0
                         ack1@tailrecurse.backedge_0)
                    ack1@%_br3_0)
                (=> (and ack1@tailrecurse._crit_edge.loopexit_0
                         ack1@tailrecurse.backedge_0)
                    (= ack1@%.tr1.be.lcssa_0 ack1@%.tr1.be_2))
                (=> (and ack1@tailrecurse._crit_edge.loopexit_0
                         ack1@tailrecurse.backedge_0)
                    (= ack1@%.tr1.be.lcssa_1 ack1@%.tr1.be.lcssa_0))
                (=> ack1@tailrecurse._crit_edge_0
                    (and ack1@tailrecurse._crit_edge_0
                         ack1@tailrecurse._crit_edge.loopexit_0))
                (=> (and ack1@tailrecurse._crit_edge_0
                         ack1@tailrecurse._crit_edge.loopexit_0)
                    (= ack1@%.tr1.lcssa_0 ack1@%.tr1.be.lcssa_1))
                (=> (and ack1@tailrecurse._crit_edge_0
                         ack1@tailrecurse._crit_edge.loopexit_0)
                    (= ack1@%.tr1.lcssa_1 ack1@%.tr1.lcssa_0))
                (=> ack1@tailrecurse._crit_edge_0
  ...
  (=> a!1
      (ack1@tailrecurse._crit_edge.split ack1@%_br1_0 ack1@arg.1_0 ack1@arg.0_0))))
(rule (=> (ack1@tailrecurse._crit_edge.split ack1@%_br1_0 ack1@arg.1_0 ack1@arg.0_0)
