...
(assert (forall ((_! Bool) (_?.0 Int) (_?.1 Int) (_*.2_6 Int) (_*.2_7 ~Mut<Int>) (_*.2_8 ~Mut<Int>) (_*.2_12 Int) (_*.2_13 ~Mut<Int>) (_*.2_14 ~Mut<Int>)) (=>
  (and (%swap_dec (~mut<~Mut<Int>> (~mut<Int> _?.0 _*.2_6) _*.2_8) (~mut<~Mut<Int>> (~mut<Int> _?.1 _*.2_12) _*.2_14)) (= (~ret<Int> _*.2_13) (~cur<Int> _*.2_13)) (= _*.2_13 _*.2_14) (= (~ret<Int> _*.2_7) (~cur<Int> _*.2_7)) (= _*.2_7 _*.2_8) (%main.3 _*.2_6 _*.2_12 _?.0 (not (>= _?.0 _*.2_6)) _!))
  (%main _!))))
; %main bb3
...
(assert (forall ((_1 ~Mut<~Mut<Int>>) (_2 ~Mut<~Mut<Int>>) (_?.1 Bool) (_*.0_2 ~Mut<Int>) (_*.0_4 ~Mut<Int>)) (=>
  ...
  (%swap_dec _1 _2))))
; %swap_dec bb2
(assert (forall ((_1 ~Mut<~Mut<Int>>) (_2 ~Mut<~Mut<Int>>) (_*.4_5 ~Mut<Int>) (_*.4_7 ~Mut<Int>)) (=>
  (and (%swap_dec (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> _1)) 1) (~ret<Int> (~cur<~Mut<Int>> _1))) _*.4_5) (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> _2)) 2) (~ret<Int> (~cur<~Mut<Int>> _2))) _*.4_7)) (= (~ret<~Mut<Int>> _1) _*.4_5) (= (~ret<~Mut<Int>> _2) _*.4_7) true)
