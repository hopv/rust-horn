...
(declare-fun %main.7 (Int Int Int ~Mut<Int> ~Mut<Int> Bool Bool) Bool)
...
(assert (forall ((_! Bool) (_?.0 Int) (_?.1 Int) (_*.2_3 Int) (_*.2_5 Int) (_*.2_9 ~Mut<Int>) (_*.2_10 ~Mut<Int>) (_*.2_13 ~Mut<Int>) (_*.2_14 ~Mut<Int>)) (=>
  (and (%swap_dec (~mut<~Mut<Int>> (~mut<Int> _?.0 _*.2_3) _*.2_10) (~mut<~Mut<Int>> (~mut<Int> _?.1 _*.2_5) _*.2_14)) (= _*.2_13 _*.2_14) (= _*.2_9 _*.2_10) (%main.3 _*.2_3 _*.2_5 _?.0 _*.2_9 _*.2_13 (>= _?.0 _*.2_3) _!))
  (%main _!))))
; %main bb3
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_4 ~Mut<Int>) (_5 ~Mut<Int>) (_! Bool)) (=>
  (and (%main.7 _1 _2 _3 _4 _5 (not false) _!))
  (%main.3 _1 _2 _3 _4 _5 false _!))))
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_4 ~Mut<Int>) (_5 ~Mut<Int>) (_! Bool)) (=>
  (and (%main.6 _1 _2 _3 _4 _5 true (<= (- _3 _1) 3) _!))
  (%main.3 _1 _2 _3 _4 _5 true _!))))
; %main bb6
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_4 ~Mut<Int>) (_5 ~Mut<Int>) (_13 Bool) (_! Bool)) (=>
  (and (%main.7 _1 _2 _3 _4 _5 (not false) _!))
  (%main.6 _1 _2 _3 _4 _5 _13 false _!))))
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_4 ~Mut<Int>) (_5 ~Mut<Int>) (_13 Bool) (_! Bool)) (=>
  (and (%main.7 _1 _2 _3 _4 _5 (not true) _!))
  (%main.6 _1 _2 _3 _4 _5 _13 true _!))))
; %main bb7
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_4 ~Mut<Int>) (_5 ~Mut<Int>) (_! Bool)) (=>
  (and (= (~ret<Int> _5) (~cur<Int> _5)) (= (~ret<Int> _4) (~cur<Int> _4)) (= _! false))
  (%main.7 _1 _2 _3 _4 _5 false _!))))
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_4 ~Mut<Int>) (_5 ~Mut<Int>) (_! Bool)) (=>
  (and (= (~ret<Int> _5) (~cur<Int> _5)) (= (~ret<Int> _4) (~cur<Int> _4)) (= _! true))
  (%main.7 _1 _2 _3 _4 _5 true _!))))
