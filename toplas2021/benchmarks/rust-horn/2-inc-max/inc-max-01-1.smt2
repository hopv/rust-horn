...
(assert (forall ((_! Bool) (_@.3 ~Tup<~Mut<Int>-~Mut<Int>>) (_?.0 Int) (_?.1 Int) (_?.2 Int) (_*.3_3 Int) (_*.3_4 Int) (_*.3_7 Int) (_*.3_8 Int) (_*.3_11 Int) (_*.3_12 Int)) (=>
  (and (%max_mid (~mut<Int> _?.0 _*.3_4) (~mut<Int> _?.1 _*.3_8) (~mut<Int> _?.2 _*.3_12) _@.3) (= _*.3_11 _*.3_12) (= _*.3_7 _*.3_8) (= _*.3_3 _*.3_4) (= (~ret<Int> (~at0/<~Mut<Int>-~Mut<Int>> _@.3)) (+ (~cur<Int> (~at0/<~Mut<Int>-~Mut<Int>> _@.3)) 2)) (= (~ret<Int> (~at1/<~Mut<Int>-~Mut<Int>> _@.3)) (+ (~cur<Int> (~at1/<~Mut<Int>-~Mut<Int>> _@.3)) 1)) (%main.4 (not (not (= _*.3_3 (+ _*.3_7 2)))) _!))
  (%main _!))))
; %main bb4
...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_@ ~Tup<~Mut<Int>-~Mut<Int>>) (_*.7_3 ~Mut<Int>) (_*.7_4 ~Mut<Int>) (_*.7_7 ~Mut<Int>) (_*.7_8 ~Mut<Int>) (_*.9_2 Int) (_*.9_4 Int)) (=>
  (and (= _*.7_8 _1) (= _*.7_4 _2) (= _*.7_7 _*.7_8) (= _*.7_3 _*.7_4) (= (~ret<Int> _3) _*.9_2) (= (~ret<Int> _*.7_3) (~cur<Int> _*.7_3)) (= (~ret<Int> _*.7_7) _*.9_4) (= _@ (~tup<~Mut<Int>-~Mut<Int>> (~mut<Int> (~cur<Int> _3) _*.9_2) (~mut<Int> (~cur<Int> _*.7_7) _*.9_4))))
