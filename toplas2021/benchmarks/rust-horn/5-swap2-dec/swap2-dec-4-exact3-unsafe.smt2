...
(declare-fun %swap2_dec_bound_three.6 (Int ~Mut<~Mut<~Mut<Int>>> ~Mut<~Mut<~Mut<Int>>> ~Mut<~Mut<~Mut<Int>>> Bool) Bool)
...
(assert (forall ((_1 Int) (_2 ~Mut<~Mut<~Mut<Int>>>) (_3 ~Mut<~Mut<~Mut<Int>>>) (_4 ~Mut<~Mut<~Mut<Int>>>) (_*.0_2 ~Mut<~Mut<Int>>) (_*.0_4 ~Mut<~Mut<Int>>) (_*.1_5 ~Mut<~Mut<Int>>) (_*.1_7 ~Mut<~Mut<Int>>) (_*.2_5 ~Mut<~Mut<Int>>) (_*.2_7 ~Mut<~Mut<Int>>) (_*.3_5 ~Mut<Int>) (_*.3_7 ~Mut<Int>) (_*.4_5 ~Mut<Int>) (_*.4_7 ~Mut<Int>) (_*.5_5 ~Mut<Int>) (_*.5_7 ~Mut<Int>)) (=>
  (and (%may_swap<~Mut<~Mut<Int>>> (~mut<~Mut<~Mut<Int>>> (~cur<~Mut<~Mut<Int>>> _2) _*.0_2) (~mut<~Mut<~Mut<Int>>> (~cur<~Mut<~Mut<Int>>> _3) _*.0_4)) (%may_swap<~Mut<~Mut<Int>>> (~mut<~Mut<~Mut<Int>>> _*.0_4 _*.1_5) (~mut<~Mut<~Mut<Int>>> (~cur<~Mut<~Mut<Int>>> _4) _*.1_7)) (%may_swap<~Mut<~Mut<Int>>> (~mut<~Mut<~Mut<Int>>> _*.0_2 _*.2_5) (~mut<~Mut<~Mut<Int>>> _*.1_5 _*.2_7)) (%may_swap<~Mut<Int>> (~mut<~Mut<Int>> (~cur<~Mut<Int>> _*.2_5) _*.3_5) (~mut<~Mut<Int>> (~cur<~Mut<Int>> _*.2_7) _*.3_7)) (%may_swap<~Mut<Int>> (~mut<~Mut<Int>> _*.3_7 _*.4_5) (~mut<~Mut<Int>> (~cur<~Mut<Int>> _*.1_7) _*.4_7)) (%may_swap<~Mut<Int>> (~mut<~Mut<Int>> _*.3_5 _*.5_5) (~mut<~Mut<Int>> _*.4_5 _*.5_7)) (%swap2_dec_bound_three.6 _1 (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> _*.5_5 (~ret<~Mut<Int>> _*.2_5)) (~ret<~Mut<~Mut<Int>>> _2)) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> _*.5_7 (~ret<~Mut<Int>> _*.2_7)) (~ret<~Mut<~Mut<Int>>> _3)) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> _*.4_7 (~ret<~Mut<Int>> _*.1_7)) (~ret<~Mut<~Mut<Int>>> _4)) (= _1 0)))
  (%swap2_dec_bound_three _1 _2 _3 _4))))
; %swap2_dec_bound_three bb6
(assert (forall ((_1 Int) (_2 ~Mut<~Mut<~Mut<Int>>>) (_3 ~Mut<~Mut<~Mut<Int>>>) (_4 ~Mut<~Mut<~Mut<Int>>>) (_*.7_11 ~Mut<~Mut<Int>>) (_*.7_13 ~Mut<~Mut<Int>>) (_*.7_15 ~Mut<~Mut<Int>>)) (=>
  (and (%swap2_dec_bound_three (- _1 1) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _2))) 1) (~ret<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _2)))) (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _2))) _*.7_11) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _3))) 2) (~ret<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _3)))) (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _3))) _*.7_13) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _4))) 3) (~ret<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _4)))) (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _4))) _*.7_15)) (= (~ret<~Mut<~Mut<Int>>> _2) _*.7_11) (= (~ret<~Mut<~Mut<Int>>> _4) _*.7_15) (= (~ret<~Mut<~Mut<Int>>> _3) _*.7_13) true)
  (%swap2_dec_bound_three.6 _1 _2 _3 _4 false))))
(assert (forall ((_1 Int) (_2 ~Mut<~Mut<~Mut<Int>>>) (_3 ~Mut<~Mut<~Mut<Int>>>) (_4 ~Mut<~Mut<~Mut<Int>>>)) (=>
  (and (= (~ret<~Mut<~Mut<Int>>> _2) (~cur<~Mut<~Mut<Int>>> _2)) (= (~ret<~Mut<~Mut<Int>>> _3) (~cur<~Mut<~Mut<Int>>> _3)) (= (~ret<~Mut<~Mut<Int>>> _4) (~cur<~Mut<~Mut<Int>>> _4)) true)
  (%swap2_dec_bound_three.6 _1 _2 _3 _4 true))))
