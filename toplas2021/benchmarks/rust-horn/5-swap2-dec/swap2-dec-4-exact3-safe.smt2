...
(assert (forall ((_1 Int) (_2 ~Mut<~Mut<~Mut<Int>>>) (_3 ~Mut<~Mut<~Mut<Int>>>) (_4 ~Mut<~Mut<~Mut<Int>>>) (_*.7_11 ~Mut<~Mut<Int>>) (_*.7_13 ~Mut<~Mut<Int>>) (_*.7_15 ~Mut<~Mut<Int>>)) (=>
  (and (%swap2_dec_bound_three (- _1 1) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _2))) 1) (~ret<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _2)))) (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _2))) _*.7_11) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _3))) 2) (~ret<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _3)))) (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _3))) _*.7_13) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _4))) 3) (~ret<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _4)))) (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> _4))) _*.7_15)) (= (~ret<~Mut<~Mut<Int>>> _2) _*.7_11) (= (~ret<~Mut<~Mut<Int>>> _3) _*.7_13) (= (~ret<~Mut<~Mut<Int>>> _4) _*.7_15) true)
  (%swap2_dec_bound_three.6 _1 _2 _3 _4 false))))
(assert (forall ((_1 Int) (_2 ~Mut<~Mut<~Mut<Int>>>) (_3 ~Mut<~Mut<~Mut<Int>>>) (_4 ~Mut<~Mut<~Mut<Int>>>)) (=>
  (and (= (~ret<~Mut<~Mut<Int>>> _4) (~cur<~Mut<~Mut<Int>>> _4)) (= (~ret<~Mut<~Mut<Int>>> _3) (~cur<~Mut<~Mut<Int>>> _3)) (= (~ret<~Mut<~Mut<Int>>> _2) (~cur<~Mut<~Mut<Int>>> _2)) true)
