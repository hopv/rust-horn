...
(assert (forall ((_! Bool) (_?.0 Int) (_?.1 Int) (_*.2_7 Int) (_*.2_8 ~Mut<Int>) (_*.2_9 ~Mut<~Mut<Int>>) (_*.2_10 ~Mut<~Mut<Int>>) (_*.2_15 Int) (_*.2_16 ~Mut<Int>) (_*.2_17 ~Mut<~Mut<Int>>) (_*.2_18 ~Mut<~Mut<Int>>)) (=>
  (and (%swap2_dec (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> _?.0 _*.2_7) _*.2_8) _*.2_10) (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> _?.1 _*.2_15) _*.2_16) _*.2_18)) (= (~ret<Int> _*.2_16) (~cur<Int> _*.2_16)) (= (~ret<~Mut<Int>> _*.2_17) (~cur<~Mut<Int>> _*.2_17)) (= _*.2_17 _*.2_18) (= (~ret<Int> _*.2_8) (~cur<Int> _*.2_8)) (= (~ret<~Mut<Int>> _*.2_9) (~cur<~Mut<Int>> _*.2_9)) (= _*.2_9 _*.2_10) (%main.3 _*.2_7 _*.2_15 _?.0 (not (>= _?.0 _*.2_7)) _!))
  (%main _!))))
; %main bb3
