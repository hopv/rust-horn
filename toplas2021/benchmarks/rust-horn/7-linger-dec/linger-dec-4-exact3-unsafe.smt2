...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_4 ~Mut<Int>)) (=>
  (and (= (~ret<Int> _4) (~cur<Int> _4)) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _3) (~cur<Int> _3)) true)
...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_4 ~Mut<Int>) (_6 Int) (_7 ~Mut<Int>) (_8 ~Mut<Int>) (_9 ~Mut<Int>) (_10 Bool) (_*.8_2 Int) (_*.8_3 Int) (_*.15_8 Int) (_*.15_10 Int) (_*.15_12 Int)) (=>
  (and (= (~ret<Int> _8) (~cur<Int> _8)) (= _*.8_2 _*.8_3) (%linger_dec_bound_three (- _1 1) (~mut<Int> (~cur<Int> _7) _*.15_8) (~mut<Int> _6 _*.15_10) (~mut<Int> (~cur<Int> _9) _*.15_12)) (= (~ret<Int> _9) _*.15_12) (= _*.8_3 _*.15_10) (= (~ret<Int> _7) _*.15_8) (= (~ret<Int> _3) (~cur<Int> _3)) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _4) (~cur<Int> _4)) true)
