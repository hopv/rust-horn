...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_4 ~Mut<Int>) (_7 Int) (_8 ~Mut<Int>) (_9 ~Mut<Int>) (_10 ~Mut<Int>) (_*.6_2 Int) (_*.6_3 Int) (_*.15_8 Int) (_*.15_10 Int) (_*.15_12 Int)) (=>
  (and (= (~ret<Int> _8) (~cur<Int> _8)) (= _*.6_2 _*.6_3) (%linger_dec_bound_three (- _1 1) (~mut<Int> _7 _*.15_8) (~mut<Int> (~cur<Int> _9) _*.15_10) (~mut<Int> (~cur<Int> _10) _*.15_12)) (= (~ret<Int> _10) _*.15_12) (= (~ret<Int> _9) _*.15_10) (= _*.6_3 _*.15_8) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _4) (~cur<Int> _4)) (= (~ret<Int> _3) (~cur<Int> _3)) true)
...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_4 ~Mut<Int>) (_7 Int) (_8 ~Mut<Int>) (_9 ~Mut<Int>) (_10 ~Mut<Int>) (_11 Bool) (_*.9_2 Int) (_*.9_3 Int) (_*.15_8 Int) (_*.15_10 Int) (_*.15_12 Int)) (=>
  (and (= (~ret<Int> _9) (~cur<Int> _9)) (= _*.9_2 _*.9_3) (%linger_dec_bound_three (- _1 1) (~mut<Int> (~cur<Int> _8) _*.15_8) (~mut<Int> _7 _*.15_10) (~mut<Int> (~cur<Int> _10) _*.15_12)) (= (~ret<Int> _10) _*.15_12) (= _*.9_3 _*.15_10) (= (~ret<Int> _8) _*.15_8) (= (~ret<Int> _4) (~cur<Int> _4)) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _3) (~cur<Int> _3)) true)
