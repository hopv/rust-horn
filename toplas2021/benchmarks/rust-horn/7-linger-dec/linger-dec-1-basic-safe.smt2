...
(assert (forall ((_1 ~Mut<Int>) (_?.0 Bool)) (=>
  ...
  (%linger_dec _1))))
; %linger_dec bb1
(assert (forall ((_1 ~Mut<Int>) (_?.2 Int) (_?.4 Bool)) (=>
  (and (%linger_dec.5 _1 _?.2 _?.4))
  (%linger_dec.1 _1 false))))
(assert (forall ((_1 ~Mut<Int>)) (=>
  (and (= (~ret<Int> _1) (~cur<Int> _1)) true)
  (%linger_dec.1 _1 true))))
; %linger_dec bb5
(assert (forall ((_1 ~Mut<Int>) (_3 Int) (_*.6_1 Int) (_*.6_2 Int) (_*.8_0 Int)) (=>
  (and (= _*.6_1 _*.6_2) (%linger_dec (~mut<Int> (~cur<Int> _1) _*.8_0)) (= _*.6_2 _*.8_0) (= (~ret<Int> _1) _*.6_1) true)
  (%linger_dec.5 _1 _3 false))))
(assert (forall ((_1 ~Mut<Int>) (_3 Int) (_*.7_2 Int) (_*.7_3 Int) (_*.7_4 Int) (_*.8_0 Int)) (=>
  (and (= _*.7_2 _*.7_3) (= _*.7_3 _*.7_4) (%linger_dec (~mut<Int> _3 _*.8_0)) (= _*.7_4 _*.8_0) (= (~ret<Int> _1) (~cur<Int> _1)) true)
  (%linger_dec.5 _1 _3 true))))

; %main
(assert (forall ((_! Bool) (_?.0 Int) (_*.1_5 Int) (_*.1_6 Int)) (=>
  (and (%linger_dec (~mut<Int> _?.0 _*.1_6)) (= _*.1_5 _*.1_6) (%main.2 _*.1_5 _?.0 (not (> _?.0 _*.1_5)) _!))
  (%main _!))))
; %main bb2
