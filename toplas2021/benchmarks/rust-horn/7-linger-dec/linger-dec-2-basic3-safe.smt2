...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_5 Int) (_6 ~Mut<Int>) (_7 ~Mut<Int>) (_8 ~Mut<Int>) (_*.6_2 Int) (_*.6_3 Int) (_*.16_3 Int) (_*.16_5 Int) (_*.16_7 Int)) (=>
  (and (= (~ret<Int> _6) (~cur<Int> _6)) (= _*.6_2 _*.6_3) (%linger_dec_three (~mut<Int> _5 _*.16_3) (~mut<Int> (~cur<Int> _7) _*.16_5) (~mut<Int> (~cur<Int> _8) _*.16_7)) (= (~ret<Int> _8) _*.16_7) (= (~ret<Int> _7) _*.16_5) (= _*.6_3 _*.16_3) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _3) (~cur<Int> _3)) (= (~ret<Int> _1) (~cur<Int> _1)) true)
...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_5 Int) (_6 ~Mut<Int>) (_7 ~Mut<Int>) (_8 ~Mut<Int>) (_9 Bool) (_*.9_2 Int) (_*.9_3 Int) (_*.16_3 Int) (_*.16_5 Int) (_*.16_7 Int)) (=>
  (and (= (~ret<Int> _7) (~cur<Int> _7)) (= _*.9_2 _*.9_3) (%linger_dec_three (~mut<Int> (~cur<Int> _6) _*.16_3) (~mut<Int> _5 _*.16_5) (~mut<Int> (~cur<Int> _8) _*.16_7)) (= (~ret<Int> _8) _*.16_7) (= _*.9_3 _*.16_5) (= (~ret<Int> _6) _*.16_3) (= (~ret<Int> _3) (~cur<Int> _3)) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _1) (~cur<Int> _1)) true)
