...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_?.1 Int) (_?.4 Bool)) (=>
  (and (%linger_dec_bound.5 _1 (~mut<Int> (- (~cur<Int> _2) 1) (~ret<Int> _2)) _?.1 (- _1 1) _?.4))
  (%linger_dec_bound.0 _1 _2 false))))
(assert (forall ((_1 Int) (_2 ~Mut<Int>)) (=>
  (and (= (~ret<Int> _2) (~cur<Int> _2)) true)
  (%linger_dec_bound.0 _1 _2 true))))
; %linger_dec_bound bb5
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_5 Int) (_7 Int) (_*.6_1 Int) (_*.6_2 Int) (_*.8_0 Int)) (=>
  (and (= _*.6_1 _*.6_2) (%linger_dec_bound _7 (~mut<Int> (~cur<Int> _2) _*.8_0)) (= _*.6_2 _*.8_0) (= (~ret<Int> _2) _*.6_1) true)
  (%linger_dec_bound.5 _1 _2 _5 _7 false))))
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_5 Int) (_7 Int) (_*.7_2 Int) (_*.7_3 Int) (_*.7_4 Int) (_*.8_0 Int)) (=>
  (and (= _*.7_2 _*.7_3) (= _*.7_3 _*.7_4) (%linger_dec_bound _7 (~mut<Int> _5 _*.8_0)) (= _*.7_4 _*.8_0) (= (~ret<Int> _2) (~cur<Int> _2)) true)
