...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_5 Int) (_6 ~Mut<Int>) (_7 ~Mut<Int>) (_8 ~Mut<Int>) (_*.8_2 Int) (_*.8_3 Int) (_*.16_3 Int) (_*.16_5 Int) (_*.16_7 Int)) (=>
  (and (= (~ret<Int> _6) (~cur<Int> _6)) (= _*.8_2 _*.8_3) (%linger_dec_three (~mut<Int> _5 _*.16_3) (~mut<Int> (~cur<Int> _7) _*.16_5) (~mut<Int> (~cur<Int> _8) _*.16_7)) (= (~ret<Int> _8) _*.16_7) (= (~ret<Int> _7) _*.16_5) (= _*.8_3 _*.16_3) (= (~ret<Int> _1) (~cur<Int> _1)) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _3) (~cur<Int> _3)) true)
...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_5 Int) (_6 ~Mut<Int>) (_7 ~Mut<Int>) (_8 ~Mut<Int>) (_9 Bool) (_*.11_2 Int) (_*.11_3 Int) (_*.16_3 Int) (_*.16_5 Int) (_*.16_7 Int)) (=>
  (and (= (~ret<Int> _7) (~cur<Int> _7)) (= _*.11_2 _*.11_3) (%linger_dec_three (~mut<Int> (~cur<Int> _6) _*.16_3) (~mut<Int> _5 _*.16_5) (~mut<Int> (~cur<Int> _8) _*.16_7)) (= (~ret<Int> _8) _*.16_7) (= _*.11_3 _*.16_5) (= (~ret<Int> _6) _*.16_3) (= (~ret<Int> _1) (~cur<Int> _1)) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _3) (~cur<Int> _3)) true)
...
(assert (forall ((_! Bool) (_?.0 Int) (_?.1 Int) (_?.2 Int) (_*.3_5 Int) (_*.3_6 Int) (_*.3_9 Int) (_*.3_10 Int) (_*.3_13 Int) (_*.3_14 Int)) (=>
  (and (%linger_dec_three (~mut<Int> _?.0 _*.3_6) (~mut<Int> _?.1 _*.3_10) (~mut<Int> _?.2 _*.3_14)) (= _*.3_13 _*.3_14) (= _*.3_9 _*.3_10) (= _*.3_5 _*.3_6) (%main.4 (not (> (- _?.0 1) _*.3_5)) _!))
  (%main _!))))
; %main bb4
