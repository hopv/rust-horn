...
(assert (forall ((_! Bool) (_@.2 ~Mut<Int>) (_?.0 Int) (_?.1 Int) (_*.2_3 Int) (_*.2_4 Int) (_*.2_7 Int) (_*.2_8 Int)) (=>
  (and (%take_max (~mut<Int> _?.0 _*.2_4) (~mut<Int> _?.1 _*.2_8) _@.2) (= _*.2_7 _*.2_8) (= _*.2_3 _*.2_4) (%main.3 _*.2_3 _*.2_7 (~mut<Int> (+ (~cur<Int> _@.2) 1) (~ret<Int> _@.2)) (not (not (= _*.2_3 _*.2_7))) _!))
  (%main _!))))
; %main bb3
