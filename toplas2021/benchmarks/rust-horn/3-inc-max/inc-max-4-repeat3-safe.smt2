...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_*.9_3 ~Mut<Int>) (_*.9_4 ~Mut<Int>) (_*.9_7 ~Mut<Int>) (_*.9_8 ~Mut<Int>)) (=>
  (and (= _*.9_8 _1) (= _*.9_4 _2) (= _*.9_7 _*.9_8) (= _*.9_3 _*.9_4) (= (~ret<Int> _3) (~cur<Int> _3)) (= (~ret<Int> _*.9_7) (+ (~cur<Int> _*.9_7) 1)) (= (~ret<Int> _*.9_3) (+ (~cur<Int> _*.9_3) 2)) true)
...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_4 ~Mut<Int>) (_5 Int) (_*.1_3 Int) (_*.1_5 Int) (_*.1_7 Int) (_*.3_11 Int) (_*.3_13 Int) (_*.3_15 Int)) (=>
  (and (%inc_max_three (~mut<Int> (~cur<Int> _2) _*.1_3) (~mut<Int> (~cur<Int> _3) _*.1_5) (~mut<Int> (~cur<Int> _4) _*.1_7)) (%inc_max_three_repeat (- _1 1) (~mut<Int> _*.1_3 _*.3_11) (~mut<Int> _*.1_5 _*.3_13) (~mut<Int> _*.1_7 _*.3_15)) (= (~ret<Int> _4) _*.3_15) (= (~ret<Int> _2) _*.3_11) (= (~ret<Int> _3) _*.3_13) (distinct _5 0) true)
