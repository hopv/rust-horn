...
(assert (forall ((_! Bool) (_?.0 Bool)) (=>
  ...
  (%main _!))))
; %main bb1
(assert (forall ((_1 Int) (_2 Int) (_! Bool) (_*.3_1 Int) (_*.3_2 Int)) (=>
  (and (= _*.3_1 _*.3_2) (%main.4 (+ _1 1) _*.3_1 (~mut<Int> 1 _*.3_2) (not (< (+ _1 1) 2)) _!))
  (%main.1 _1 _2 false _!))))
(assert (forall ((_1 Int) (_2 Int) (_! Bool) (_*.2_0 Int)) (=>
  (and (%main.4 (+ _*.2_0 1) _2 (~mut<Int> 1 _*.2_0) (not (< (+ _*.2_0 1) 2)) _!))
  (%main.1 _1 _2 true _!))))
; %main bb4
