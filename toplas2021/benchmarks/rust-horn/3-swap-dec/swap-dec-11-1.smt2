...
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_4 Int) (_5 Int) (_6 ~Mut<Int>) (_7 ~Mut<Int>) (_8 ~Mut<Int>) (_! Bool)) (=>
  (and (= (~ret<Int> _6) (~cur<Int> _6)) (= (~ret<Int> _7) (~cur<Int> _7)) (= (~ret<Int> _8) (~cur<Int> _8)) (%main.9 (not false) _!))
...
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_4 Int) (_5 Int) (_6 ~Mut<Int>) (_7 ~Mut<Int>) (_8 ~Mut<Int>) (_19 Bool) (_! Bool)) (=>
  (and (= (~ret<Int> _6) (~cur<Int> _6)) (= (~ret<Int> _7) (~cur<Int> _7)) (= (~ret<Int> _8) (~cur<Int> _8)) (%main.9 (not true) _!))
...
(assert (forall ((_1 Int) (_2 ~Mut<~Mut<Int>>) (_3 ~Mut<~Mut<Int>>) (_4 ~Mut<~Mut<Int>>) (_*.4_11 ~Mut<Int>) (_*.4_13 ~Mut<Int>) (_*.4_15 ~Mut<Int>)) (=>
  (and (%swap_dec_bound_three (- _1 1) (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> _2)) 1) (~ret<Int> (~cur<~Mut<Int>> _2))) _*.4_11) (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> _3)) 2) (~ret<Int> (~cur<~Mut<Int>> _3))) _*.4_13) (~mut<~Mut<Int>> (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> _4)) 3) (~ret<Int> (~cur<~Mut<Int>> _4))) _*.4_15)) (= (~ret<~Mut<Int>> _4) _*.4_15) (= (~ret<~Mut<Int>> _2) _*.4_11) (= (~ret<~Mut<Int>> _3) _*.4_13) true)
  (%swap_dec_bound_three.3 _1 _2 _3 _4 false))))
(assert (forall ((_1 Int) (_2 ~Mut<~Mut<Int>>) (_3 ~Mut<~Mut<Int>>) (_4 ~Mut<~Mut<Int>>)) (=>
  (and (= (~ret<~Mut<Int>> _4) (~cur<~Mut<Int>> _4)) (= (~ret<~Mut<Int>> _2) (~cur<~Mut<Int>> _2)) (= (~ret<~Mut<Int>> _3) (~cur<~Mut<Int>> _3)) true)
