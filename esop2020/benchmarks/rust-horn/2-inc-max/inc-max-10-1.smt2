...
; %inc_max_repeat bb0
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_@.1 ~Mut<Int>) (_*.1_3 Int) (_*.1_5 Int) (_*.4_10 Int) (_*.4_12 Int)) (=>
  (and (%take_max (~mut<Int> (~cur<Int> _2) _*.1_3) (~mut<Int> (~cur<Int> _3) _*.1_5) _@.1) (%inc_max_repeat (- _1 1) (~mut<Int> _*.1_3 _*.4_10) (~mut<Int> _*.1_5 _*.4_12)) (= (~ret<Int> _@.1) (+ (~cur<Int> _@.1) 1)) (= (~ret<Int> _3) _*.4_12) (= (~ret<Int> _2) _*.4_10) true)
