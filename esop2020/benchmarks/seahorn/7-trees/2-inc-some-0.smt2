(set-info :original "7-trees/2-inc-some-0.bc")
...
(declare-var main@%xs.tr.ph.i2.lcssa_1 Int )
...
(declare-var main@%xs.tr.ph.i2_0 Int )
(declare-var main@%xs.tr.ph.i2_1 Int )
...
(declare-var main@%xs.tr.ph.i2_2 Int )
(declare-var main@some.exit_0 Bool )
(declare-var main@%xs.tr.ph.i2.lcssa_0 Int )
...
(rule (=> (and (main@entry @nd_0)
         ...
         main@tailrecurse.i_0
         (=> (and main@tailrecurse.i_0 main@tailrecurse.i.preheader_0)
             (= main@%xs.tr.ph.i2_0 main@%_2_0))
         (=> (and main@tailrecurse.i_0 main@tailrecurse.i.preheader_0)
             (= main@%xs.tr.ph.i2_1 main@%xs.tr.ph.i2_0)))
    (main@tailrecurse.i
      @nd_0
      main@%xs.tr.ph.i2_1
      main@%_3_0
...
(rule (let ((a!1 (= main@%_12_0 (+ (+ main@%xs.tr.ph.i2_0 (* 0 12)) 8)))
      (a!2 (= main@%_13_0 (+ (+ main@%xs.tr.ph.i2_0 (* 0 12)) 4))))
(let ((a!3 (and (main@tailrecurse.i
                ...
                (=> main@tailrecurse.outer.backedge.i_0
                    (or (<= main@%xs.tr.ph.i2_0 0) (> main@%_12_0 0)))
                (=> main@tailrecurse.outer.backedge.i_0 a!2)
                (=> main@tailrecurse.outer.backedge.i_0
                    (or (<= main@%xs.tr.ph.i2_0 0) (> main@%_13_0 0)))
                (=> main@tailrecurse.outer.backedge.i_0
                ...
                (=> (and main@tailrecurse.i_1
                         main@tailrecurse.outer.backedge.i_0)
                    (= main@%xs.tr.ph.i2_1 main@%xs.tr.ph.be.i_0))
                (=> (and main@tailrecurse.i_1
                         main@tailrecurse.outer.backedge.i_0)
                    (= main@%xs.tr.ph.i2_2 main@%xs.tr.ph.i2_1)))))
  (=> a!3
      (main@tailrecurse.i
        @nd_0
        main@%xs.tr.ph.i2_2
...
(rule (let ((a!1 (=> main@some.exit_0
               (= main@%_15_0 (+ main@%xs.tr.ph.i2.lcssa_1 (* 0 12) 0)))))
(let ((a!2 (and (main@tailrecurse.i
                ...
                (=> (and main@some.exit_0 main@tailrecurse.i_0)
                    (not main@%_8_0))
                (=> (and main@some.exit_0 main@tailrecurse.i_0)
                    (= main@%xs.tr.ph.i2.lcssa_0 main@%xs.tr.ph.i2_0))
                (=> (and main@some.exit_0 main@tailrecurse.i_0)
                    (= main@%xs.tr.ph.i2.lcssa_1 main@%xs.tr.ph.i2.lcssa_0))
                a!1
                (=> main@some.exit_0
                    (or (<= main@%xs.tr.ph.i2.lcssa_1 0) (> main@%_15_0 0)))
                (=> main@some.exit_0
