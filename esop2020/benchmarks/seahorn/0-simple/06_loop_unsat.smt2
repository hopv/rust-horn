...
(rule (=> (and main@entry
    ...
    (main@.lr.ph main@%y.0.i2_1 main@%x.0.i1_1)))
...
(rule (=> (and (main@.lr.ph main@%y.0.i2_0 main@%x.0.i1_0)
         true
         ...
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%y.0.i2_1 main@%_3_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%x.0.i1_1 main@%_2_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%y.0.i2_2 main@%y.0.i2_1))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%x.0.i1_2 main@%x.0.i1_1)))
    (main@.lr.ph main@%y.0.i2_2 main@%x.0.i1_2)))
(rule (let ((a!1 (and (main@.lr.ph main@%y.0.i2_0 main@%x.0.i1_0)
                true
                (= main@%_2_0 (+ main@%y.0.i2_0 main@%x.0.i1_0))
                (= main@%_3_0 (+ main@%y.0.i2_0 1))
                (= main@%_5_0 (= main@%_4_0 0))
                ...
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%y.0.i.lcssa_0 main@%.lcssa8_1))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
