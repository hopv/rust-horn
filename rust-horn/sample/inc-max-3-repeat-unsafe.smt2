...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_4 Int) (_@.1 ~Mut<Int>) (_*.1_3 Int) (_*.1_5 Int) (_*.2_10 Int) (_*.2_12 Int)) (=>
  (and (%take_max (~mut<Int> (~cur<Int> _2) _*.1_3) (~mut<Int> (~cur<Int> _3) _*.1_5) _@.1) (%inc_max_repeat (- _1 1) (~mut<Int> _*.1_3 _*.2_10) (~mut<Int> _*.1_5 _*.2_12)) (= (~ret<Int> _@.1) (+ (~cur<Int> _@.1) 1)) (= (~ret<Int> _2) _*.2_10) (= (~ret<Int> _3) _*.2_12) (distinct _4 0) true)
...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_@ ~Mut<Int>)) (=>
  ...
  (%take_max _1 _2 _@))))
; %take_max bb0
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_@ ~Mut<Int>) (_*.2_0 Int) (_*.3_0 Int) (_*.3_2 Int)) (=>
  (and (= _*.2_0 _*.3_0) (= _*.3_0 _*.3_2) (= (~ret<Int> _1) (~cur<Int> _1)) (= (~ret<Int> _2) _*.2_0) (= _@ (~mut<Int> (~cur<Int> _2) _*.3_2)))
