...
; %main
(assert (forall ((_! Bool) (_@0.1 LockHistory<Int>) (_@0.2 LockHistory<Int>) (_@0.3 LockHistory<Int>) (_@0.4 ~Mut<Int>) (_@0.6 ~Mut<Int>) (_@0.8 ~Mut<Int>) (_?.0 Int) (_*.2_4 LockHistory<Int>) (_*.3_4 LockHistory<Int>) (_*.4_4 LockHistory<Int>) (_*.6_4 LockHistory<Int>) (_*.8_7 LockHistory<Int>) (_%.nonce LockHistory<Int>)) (=>
