...
; %main
(assert (forall ((_! Bool) (_?.0 %List) (_@.1 Int) (_*.2_7 %List) (_@.2 ~Mut<Int>) (_*.2_6 %List) (_@.3 Int)) (=>
...
(assert (forall ((_1 %List) (_@ Int)) (=>
  ...
  (%sum _1 _@))))
; %sum bb0
(assert (forall ((_$.0_0/0 Int) (_$.0_0/1 %List) (_@ Int) (_@.4 Int)) (=>
...
(assert (forall ((_1 ~Mut<%List>) (_@ ~Mut<Int>)) (=>
  ...
  (%take_some _1 _@))))
; %take_some bb0
(assert (forall ((_$.0_0/0 Int) (_$.0_0/1 %List) (_1 ~Mut<%List>) (_@ ~Mut<Int>) (_*.4_1 Int) (_*.4_3 %List) (_?.4 Bool)) (=>
...
(assert (forall ((_1 ~Mut<%List>) (_@ ~Mut<Int>) (_*.3_2 %List) (_@.3 ~Mut<Int>) (_*.10_0 Int) (_*.11_0 Int) (_*.11_1 Int)) (=>
...
; %take_some bb5
(assert (forall ((_1 ~Mut<%List>) (_5 ~Mut<Int>) (_6 ~Mut<%List>) (_@ ~Mut<Int>) (_*.7_2 %List) (_@.7 ~Mut<Int>) (_*.8_0 Int) (_*.9_0 Int) (_*.9_2 Int) (_*.11_0 Int) (_*.11_1 Int)) (=>
