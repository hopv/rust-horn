...
(declare-fun %main.4 (%List Bool Bool) Bool)
...
(assert (forall ((_! Bool) (_@.1 Int) (_@.2 ~Mut<Int>) (_@.3 Int) (_?.0 %List) (_*.2_5 %List) (_*.2_6 %List)) (=>
  (and (%sum _?.0 _@.1) (%take_some (~mut<%List> _?.0 _*.2_6) _@.2) (= _*.2_5 _*.2_6) (%sum _*.2_5 _@.3) (= (~ret<Int> _@.2) (+ (~cur<Int> _@.2) 1)) (%main.4 _*.2_5 (not (> _@.3 (+ _@.1 1))) _!))
  (%main _!))))
; %main bb4
...
; %take_some bb4
(assert (forall ((_1 ~Mut<%List>) (_5 ~Mut<Int>) (_6 ~Mut<%List>) (_@ ~Mut<Int>) (_@.6 ~Mut<Int>) (_*.6_2 %List) (_*.7_0 Int) (_*.8_0 Int) (_*.8_2 Int) (_*.10_0 Int) (_*.10_1 Int)) (=>
  (and (%take_some (~mut<%List> (~cur<%List> _6) _*.6_2) _@.6) (= (~ret<Int> _@.6) _*.7_0) (= _*.7_0 _*.8_0) (= _*.8_0 _*.8_2) (= (~ret<%List> _6) _*.6_2) (= (~ret<Int> _5) (~cur<Int> _5)) (= _*.8_2 _*.10_0) (= _*.10_0 _*.10_1) (= (~ret<%List> _1) (~cur<%List> _1)) (= _@ (~mut<Int> (~cur<Int> _@.6) _*.10_1)))
