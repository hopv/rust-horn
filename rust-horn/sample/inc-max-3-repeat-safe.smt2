...
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_! Bool)) (=>
  (and (%main.6 _1 _2 _3 false (>= (- _3 _2) _1) _!))
...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_@ ~Mut<Int>)) (=>
  ...
  (%take_max _1 _2 _@))))
; %take_max bb0
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_@ ~Mut<Int>) (_*.2_2 Int) (_*.3_0 Int) (_*.3_2 Int)) (=>
  (and (= _*.2_2 _*.3_0) (= _*.3_0 _*.3_2) (= (~ret<Int> _1) (~cur<Int> _1)) (= (~ret<Int> _2) _*.2_2) (= _@ (~mut<Int> (~cur<Int> _2) _*.3_2)))
  (%take_max.0 _1 _2 false _@))))
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_@ ~Mut<Int>) (_*.1_3 Int) (_*.1_4 Int) (_*.3_0 Int) (_*.3_2 Int)) (=>
  (and (= _*.1_3 _*.1_4) (= _*.1_4 _*.3_0) (= _*.3_0 _*.3_2) (= (~ret<Int> _1) _*.1_3) (= (~ret<Int> _2) (~cur<Int> _2)) (= _@ (~mut<Int> (~cur<Int> _1) _*.3_2)))
