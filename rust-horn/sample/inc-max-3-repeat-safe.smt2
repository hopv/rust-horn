...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_4 Int) (_@.1 ~Mut<Int>) (_*.1_3 Int) (_*.1_5 Int) (_*.3_10 Int) (_*.3_12 Int)) (=>
  (and (%take_max (~mut<Int> (~cur<Int> _2) _*.1_3) (~mut<Int> (~cur<Int> _3) _*.1_5) _@.1) (%inc_max_repeat (- _1 1) (~mut<Int> _*.1_3 _*.3_10) (~mut<Int> _*.1_5 _*.3_12)) (= (~ret<Int> _@.1) (+ (~cur<Int> _@.1) 1)) (= (~ret<Int> _3) _*.3_12) (= (~ret<Int> _2) _*.3_10) (distinct _4 0) true)
...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_@ ~Mut<Int>) (_*.2_1 Int) (_*.2_2 Int) (_*.3_0 Int) (_*.3_2 Int)) (=>
  (and (= _*.2_1 _*.2_2) (= _*.2_2 _*.3_0) (= _*.3_0 _*.3_2) (= (~ret<Int> _2) _*.2_1) (= (~ret<Int> _1) (~cur<Int> _1)) (= _@ (~mut<Int> (~cur<Int> _2) _*.3_2)))
  (%take_max.0 _1 _2 false _@))))
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_@ ~Mut<Int>) (_*.1_1 Int) (_*.1_2 Int) (_*.3_0 Int) (_*.3_2 Int)) (=>
  (and (= _*.1_1 _*.1_2) (= _*.1_2 _*.3_0) (= _*.3_0 _*.3_2) (= (~ret<Int> _2) (~cur<Int> _2)) (= (~ret<Int> _1) _*.1_1) (= _@ (~mut<Int> (~cur<Int> _1) _*.3_2)))
