...
; %main
(assert (forall ((_! Bool) (_@0.0 ChannelBuf<Int>) (_*.1_8 ChannelBuf<Int>) (_@0.1 ChannelBuf<Int>) (_@0 Real) (_*.2_4 ChannelBuf<Int>) (_*.3_4 ChannelBuf<Int>) (_@0.6 Int) (_@1 Real) (_*.6_4 ChannelBuf<Int>) (_@2 Real) (_@0.7 Int) (_@3 Real) (_*.7_4 ChannelBuf<Int>) (_@4 Real) (_%.nonce ChannelBuf<Int>)) (=>
  (and (Sorted _@0.0) (MergeInt _*.1_8 _@0.1 _@0.0) (= _*.1_8 (insert 1 _@0 _*.2_4)) (= _@0.1 (insert 2 _@0 _*.3_4)) (= _*.2_4 nilBuf) (= _*.3_4 nilBuf) (= _@0.0 (insert _@0.6 _@1 _*.6_4)) (< _@1 _@2) (<= _@0 _@2) (= _*.6_4 (insert _@0.7 _@3 _*.7_4)) (< _@3 _@4) (<= _@2 _@4) (%main.8 _%.nonce _*.7_4 _%.nonce _@0.6 _@0.7 (= _@0.7 1) _!))
  (%main _!))))
; %main bb8
