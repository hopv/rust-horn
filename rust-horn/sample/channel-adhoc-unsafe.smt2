...
; %main
(assert (forall ((_! Bool) (_@0.0 ChannelBuf<int>) (_@0.1 ChannelBuf<int>) (_@0.6 Int) (_@0.7 Int) (_*.1_8 ChannelBuf<int>) (_*.2_4 ChannelBuf<int>) (_*.3_4 ChannelBuf<int>) (_*.6_4 ChannelBuf<int>) (_*.7_4 ChannelBuf<int>) (_%.nonce ChannelBuf<int>)) (=>
  (and (MergeInt _*.1_8 _@0.1 _@0.0) (= _*.1_8 (insert 1 _*.2_4)) (= _@0.1 (insert 2 _*.3_4)) (= _*.2_4 nil) (= _*.3_4 nil) (= _@0.0 (insert _@0.6 _*.6_4)) (= _*.6_4 (insert _@0.7 _*.7_4)) (%main.8 _%.nonce _*.7_4 _%.nonce _@0.6 _@0.7 (= _@0.6 1) _!))
  (%main _!))))
; %main bb8
